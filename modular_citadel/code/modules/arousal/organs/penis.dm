...
/obj/item/organ/genital/penis/update_appearance()
	...
	desc = "You see [aroused_state ? "an erect" : "a flacid"] [lowershape] penis. You estimate it's about [round(length, 0.25)] inch[round(length, 0.25) != 1 ? "es" : ""] long and [round(girth, 0.25)] inch[round(girth, 0.25) != 1 ? "es" : ""] in girth."
