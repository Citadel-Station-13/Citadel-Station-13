...
/obj/item/storage/backpack/rig
	...
	armor = list("melee" = 40, "bullet" = 5, "laser" = 20,"energy" = 5, "bomb" = 35, "bio" = 100, "rad" = 20, "fire" = 80, "acid" = 100)
	...
	var/air_type =   /obj/item/tank/internals

	//Component/device holders.
	var/obj/item/tank/internals        					              // Air tank, if any.
	...
	var/obj/item/stock_parts/cell                      				// Power supply, if any.
