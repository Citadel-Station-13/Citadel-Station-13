...
/obj/item/lighter/gold
	...
	flags_1 = CONDUCT_1
	slot_flags = INVENTORY_SLOT_BELT
	heat = 1500
...
/obj/item/clothing/suit/hooded/cloak/zuliecloak
	...
	slot_flags = INVENTORY_SLOT_OUTERWEAR | ITEM_SLOT_NECK //it's a cloak. it's cosmetic. so why the hell not? what could possibly go wrong?
	mutantrace_variation = NONE
