...
/obj/item/reagent_containers/pill/tox
	...
	desc = "Highly toxic."
	icon_state = "pill5"
	list_reagents = list("toxin" = 5)
	roundstart = 1
/obj/item/reagent_containers/pill/cyanide
	name = "cyanide pill"
	desc = "Don't swallow this."
	icon_state = "pill5"
	list_reagents = list("cyanide" = 5)
	roundstart = 1
...
/obj/item/reagent_containers/pill/stimulant
	...
	icon_state = "pill19"
	list_reagents = list("ephedrine" = 2, "antihol" = 1, "coffee" = 2)
	roundstart = 1
/obj/item/reagent_containers/pill/salbutamol
	name = "salbutamol pill"
	desc = "Used to treat oxygen deprivation."
	icon_state = "pill16"
	list_reagents = list("salbutamol" = 5)
	roundstart = 1
...
/obj/item/reagent_containers/pill/salicyclic
	...
	icon_state = "pill9"
	list_reagents = list("sal_acid" = 5)
	roundstart = 1
/obj/item/reagent_containers/pill/oxandrolone
	name = "oxandrolone pill"
	desc = "Used to stimulate burn healing."
	icon_state = "pill11"
	list_reagents = list("oxandrolone" = 5)
	roundstart = 1
