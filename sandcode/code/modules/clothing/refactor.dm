/obj/item/clothing/suit/armor/vest/warden
	...
	taur_mob_worn_overlay = 'sandcode/icons/mob/suits_taur.dmi'
...
/obj/item/clothing/shoes/jackboots/Initialize()
	. = ..()
	AddComponent(/datum/component/squeak, list('sandcode/sound/effects/jackboot1.ogg'=1, 'sandcode/sound/effects/jackboot2.ogg'=1), 50)
