...
/mob/living/proc/pregoodbye(C)
	...
	playsound(C, "sandcode/sound/effects/admin_punish/changetheworld.ogg", 100, FALSE)
	say("Change the world")
	sleep(20)
	playsound(C, "sandcode/sound/effects/admin_punish/myfinalmessage.ogg", 100, FALSE)
	say("My final message")
	sleep(20)
	playsound(C, "sandcode/sound/effects/admin_punish/goodbye.ogg", 100, FALSE)
	say("Goodbye.")
	sleep(20)
	playsound(C, "sandcode/sound/effects/admin_punish/endjingle.ogg", 100, FALSE)
	goodbye()
