...
/obj/item/tank/internals/generic
	...
	icon = 'sandcode/icons/obj/tank.dmi'
	icon_state = "generic"
	lefthand_file = 'sandcode/icons/mob/inhands/equipment/tanks_lefthand.dmi'
	righthand_file = 'sandcode/icons/mob/inhands/equipment/tanks_righthand.dmi'
	mob_overlay_icon = 'sandcode/icons/mob/clothing/back.dmi'
