/obj/machinery/mecha_part_fabricator_adv
	icon = 'sandcode/icons/obj/robotics.dmi'
	icon_state = "fab-idle"
	name = "advanced exosuit fabricator"
	...
	circuit = /obj/item/circuitboard/machine/mechfab_adv
	var/time_coeff = 1
...
/obj/machinery/mecha_part_fabricator_adv/Initialize(mapload)
	stored_research = new
...
/obj/machinery/mecha_part_fabricator_adv/proc/output_available_resources()
	var/output
...
/obj/machinery/mecha_part_fabricator_adv/proc/get_resources_w_coeff(datum/design/D)
	var/list/resources = list()
	for(var/R in D.materials)
		resources[R] = get_resource_cost_w_coeff(D, R)
	return resources

/obj/machinery/mecha_part_fabricator_adv/proc/check_resources(datum/design/D)
...
/obj/machinery/mecha_part_fabricator_adv/proc/build_part(datum/design/D)
...
/obj/machinery/mecha_part_fabricator_adv/proc/update_queue_on_page()
	send_byjax(usr,"mecha_fabricator.browser","queue",list_queue())
	return

/obj/machinery/mecha_part_fabricator_adv/proc/add_part_set_to_queue(set_name)
...
/obj/machinery/mecha_part_fabricator_adv/proc/add_to_queue(D)
	if(!istype(queue))
		queue = list()
	if(D)
		queue[++queue.len] = D
...
/obj/machinery/mecha_part_fabricator_adv/proc/remove_from_queue(index)
	if(!isnum(index) || !ISINTEGER(index) || !istype(queue) || (index<1 || index>queue.len))
		return FALSE
	queue.Cut(index,++index)
	return TRUE

/obj/machinery/mecha_part_fabricator_adv/proc/process_queue()
...
/obj/machinery/mecha_part_fabricator_adv/proc/list_queue()
...
/obj/machinery/mecha_part_fabricator_adv/proc/sync()
...
/obj/machinery/mecha_part_fabricator_adv/proc/get_resource_cost_w_coeff(datum/design/D, resource, roundto = 1)
	return round(D.materials[resource]*component_coeff, roundto)

/obj/machinery/mecha_part_fabricator_adv/proc/get_construction_time_w_coeff(datum/design/D, roundto = 1) //aran
	return round(initial(D.construction_time)*time_coeff, roundto)

/obj/machinery/mecha_part_fabricator_adv/ui_interact(mob/user as mob)
	. = ..()
	var/dat, left_part
...
/obj/machinery/mecha_part_fabricator_adv/Topic(href, href_list)
	if(..())
		return
...
/obj/machinery/mecha_part_fabricator_adv/proc/do_process_queue()		
	if(processing_queue || being_built)		
		return FALSE		
	processing_queue = 1
	process_queue()		
...
/obj/machinery/mecha_part_fabricator_adv/proc/eject_sheets(eject_sheet, eject_amt)
...
/obj/machinery/mecha_part_fabricator_adv/proc/AfterMaterialInsert(type_inserted, id_inserted, amount_inserted)
...
/obj/machinery/mecha_part_fabricator_adv/attackby(obj/item/W, mob/user, params)
...
/obj/machinery/mecha_part_fabricator_adv/proc/material2name(ID)
	return copytext(ID,2)

/obj/machinery/mecha_part_fabricator_adv/proc/is_insertion_ready(mob/user)
	if(panel_open)
...
/obj/machinery/mecha_part_fabricator_adv/maint
	link_on_init = FALSE
