...
var Panel = function Panel(props, context) {
  ...
  return (0, _inferno.createComponentVNode)(2, _layouts.Pane, {
    "theme": settings.theme === 'default' ? 'light' : settings.theme,
...
var ChatRenderer = /*#__PURE__*/function () {
  ...
  _proto.setHighlight = function () {
    function setHighlight(text, color) {
      ...
      var allowedRegex = /^[a-z0-9_\-\s]+$/i; // citadel update - ig changed to i for flags, to fix issues with highlighting only working for every other word.
...
var setupApp = function setupApp() {
  ...
  based_winset(); // Enable hot module reloading

  if (false) {}
};

var based_winset = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function () {
    function _callee(based_on_what) {
      var winget_output;
      return regeneratorRuntime.wrap(function () {
        function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (based_on_what === void 0) {
                  based_on_what = 'output';
                }

                _context.next = 3;
                return Byond.winget(based_on_what);

              case 3:
                winget_output = _context.sent;
                Byond.winset('browseroutput', {
...
var COLOR_DARK_INFO_BUTTONS_BG = "#40628A";
var COLOR_DARK_BG = "#272727";
var COLOR_DARK_DARKBG = "#242424";
var COLOR_DARK_TEXT = "#E0E0E0";
var COLOR_WHITE_INFO_BUTTONS_BG = "#90B3DD";
var COLOR_WHITE_BG = "#F0F0F0";
var COLOR_WHITE_DARKBG = "#E6E6E6";
var COLOR_WHITE_TEXT = "#000000";
