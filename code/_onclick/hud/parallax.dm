...
/datum/hud/proc/update_parallax1()
	...
	if(!C.parallax_master)
		C.parallax_master = PoolOrNew(/obj/screen/parallax_master)
	if(!C.parallax_canvas)
		C.parallax_canvas = PoolOrNew(/obj/screen/parallax_canvas)
	if(!C.parallax_voidmaster)
		C.parallax_voidmaster = PoolOrNew(/obj/screen/parallax_voidmaster)
	if(!C.parallax_dustmaster)
		C.parallax_dustmaster = PoolOrNew(/obj/screen/parallax_dustmaster)
