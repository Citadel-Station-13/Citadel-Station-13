...
/obj/item/book/granter/crafting_recipe/bone_bow //Bow crafting for non-ashwalkers
	name = "Standstone manual on bows"
	desc = "A standstone slab with everything you need to know for making bows and arrows just like an ashwalker would."
	crafting_recipe_types = list(/datum/crafting_recipe/bone_arrow, /datum/crafting_recipe/bone_bow, /datum/crafting_recipe/ashen_arrow, /datum/crafting_recipe/bow_tablet)
	icon_state = "stone_tablet"
	oneuse = FALSE
	remarks = list("Sticking burning arrows into the sand makes them stronger?", "Braking the bone apart to get shards, not sharpening  the bone.", "Sinew is just like rope?")
