...
/obj/item/pda
	...
	var/note = "Congratulations, your station has chosen the Thinktronic 5230 Personal Data Assistant!Congratulations, your station has chosen the Thinktronic 5230 Personal Data Assistant! To help with navigation we have provided the following definitions! Port, also known as West. Bow also known as North. Starboard, also known as East. Quarter also known as South." //Current note in the notepad function
	var/notehtml = ""
