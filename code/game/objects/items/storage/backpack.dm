...
/obj/item/boh_inert
	...
	desc = "What is currently a just an unwieldly block of metal with a slot ready to accept a bluespace anomaly core. Craft this with a bluespace anomaly core to produce a bag of holding."
