...
/obj/item/storage/box/donkpockets
	...
	desc = "<B>Instructions:</B> <I>Heat in microwave. Product will cool if not eaten within seven minutes. WARNING: Eating too many at once may lead to bodily harm!</I>"
