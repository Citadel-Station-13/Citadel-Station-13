...
GLOBAL_LIST_INIT(gift_blacklist, typecacheof(list(
	/obj/effect,
	/obj/belly,
...
/obj/item/a_gift/anything/get_gift_type()
	if(!GLOB.possible_gifts.len)
		...
		for(var/V in gift_types_list)
			var/obj/item/I = V
			if((!initial(I.icon_state)) || (!initial(I.item_state)) || (initial(I.item_flags) & ABSTRACT) || (is_type_in_typecache(I, GLOB.gift_blacklist)))
				gift_types_list -= V
