...
/obj/item/dnainjector/antifire
	...
	desc = "Cures cold resistance."
	remove_mutations = list(COLDMUT)

/obj/item/dnainjector/firemut
	name = "\improper DNA injector (Cold)"
	desc = "Gives you cold resistance."
	add_mutations = list(COLDMUT)

/obj/item/dnainjector/antispace
	name = "\improper DNA injector (Anti-Space)"
	desc = "In space, no one can hear you scream."
	remove_mutations = list(SPACEMUT)

/obj/item/dnainjector/spacemut
	name = "\improper DNA injector (Space)"
	desc = "Makes you spaceproof."
