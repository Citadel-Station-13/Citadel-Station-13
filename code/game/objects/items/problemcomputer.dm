...
/obj/item/computermath
	icon = 'icons/obj/computermath.dmi'
	icon_state = "tablet"
	verb_say = "beeps"
	var/charge_count
...
/obj/item/computermath/default
	...
	icon_state = "tabletdefault"

	var/static/radial_cargo = image(icon = 'icons/obj/computermath.dmi', icon_state = "tabletcargo")
	var/static/radial_science = image(icon = 'icons/obj/computermath.dmi', icon_state = "tabletsci")
