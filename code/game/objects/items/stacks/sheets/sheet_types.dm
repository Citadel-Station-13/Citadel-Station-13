...
GLOBAL_LIST_INIT(plasteel_recipes, list ( \
	...
	new /datum/stack_recipe_list("crates", list( \
		...
		new /datum/stack_recipe("radiation containment crate", /obj/structure/closet/crate/radiation, 20, time = 50, one_per_turf = 1, on_floor = 1), \
		...
		new /datum/stack_recipe("RCD storge crate", /obj/structure/closet/crate/rcd, 5, time = 50, one_per_turf = 1, on_floor = 1), \
