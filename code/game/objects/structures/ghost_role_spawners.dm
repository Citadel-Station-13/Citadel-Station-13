...
/obj/effect/mob_spawn/human/ghostcafe/special(mob/living/carbon/human/new_spawn)
	if(new_spawn.client)
		...
		new_spawn.AddElement(/datum/element/dusts_on_leaving_area,list(A.type,/area/hilbertshotel, /area/centcom/holding/cafe, /area/centcom/holding/cafemed, /area/centcom/holding/cafebuild, /area/centcom/holding/cafewar))
		...
		ADD_TRAIT(new_spawn, TRAIT_PACIFISM,"cafe_pacifism")
