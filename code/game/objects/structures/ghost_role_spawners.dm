...
/obj/effect/mob_spawn/human/ash_walker/special(mob/living/new_spawn)
	...
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/bonearmor)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/bonetalisman)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/bracers)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/bonebag)
