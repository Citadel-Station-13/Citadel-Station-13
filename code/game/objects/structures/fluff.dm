...
/obj/structure/fluff/lightpost/light
	desc = "That which most enchants the Edinians is the lighting by gas of the boulevards... These humble rows of lamps, shining with a clarity white and pure, have a marvelous effect upon the streets on Nova Edina."
	light_power = 0.8
	light_range = 10
	light_color = "#ffbb4d"
