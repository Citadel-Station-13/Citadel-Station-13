<<<<<<< HEAD:code/game/machinery/computer/message.dm
...
// The monitor itself.
>>>>>>> 911cb97... Tidy telecomms radio code, make PDA server real telecomms machinery (#33647):code/game/machinery/telecomms/computers/message.dm
