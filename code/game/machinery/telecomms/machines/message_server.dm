...
/obj/machinery/blackbox_recorder/on_attack_hand(mob/living/user)
	. = ..()
	if(stored)
...
/obj/machinery/telecomms/message_server/Initialize(mapload)
	...
	if (calibrating)
		...
		pda_msgs += new /datum/data_pda_msg("System Administrator", "system", "This is an automated message. System calibration started at [STATION_TIME_TIMESTAMP("hh:mm:ss", world.time)]")
	else
