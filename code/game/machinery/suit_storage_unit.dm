...
/obj/machinery/suit_storage_unit/interact(mob/living/user)
	...
	if (locked)
		choices["unlock"] = icon('icons/radials/suitstorage.dmi', "radial_unlock")
	else if (state_open)
		choices["close"] = icon('icons/radials/suitstorage.dmi', "radial_close")
		...
		choices["open"] = icon('icons/radials/suitstorage.dmi', "radial_open")
		choices["disinfect"] = icon('icons/radials/suitstorage.dmi', "radial_disinfect")
		choices["lock"] = icon('icons/radials/suitstorage.dmi', "radial_lock")
