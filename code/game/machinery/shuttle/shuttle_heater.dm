...
//it for the engine.
//-----------------------------------------------
/obj/machinery/atmospherics/component/unary/shuttle
	name = "shuttle atmospherics device"
	desc = "This does something to do with shuttle atmospherics"
	icon_state = "heater"
	icon = 'icons/turf/shuttle.dmi'

/obj/machinery/atmospherics/component/unary/shuttle/heater
	name = "engine heater"
...
/obj/machinery/atmospherics/component/unary/shuttle/heater/New()
	. = ..()
...
/obj/machinery/atmospherics/component/unary/shuttle/heater/Destroy()
	. = ..()
	update_adjacent_engines()
	GLOB.custom_shuttle_machines -= src

/obj/machinery/atmospherics/component/unary/shuttle/heater/on_construction()
	..(dir, dir)
	SetInitDirections()
	update_adjacent_engines()

/obj/machinery/atmospherics/component/unary/shuttle/heater/default_change_direction_wrench(mob/user, obj/item/I)
	if(!..())
		return FALSE
	SetInitDirections()
...
/obj/machinery/atmospherics/component/unary/shuttle/heater/RefreshParts()
	var/cap = 0
	var/eff = 0
...
/obj/machinery/atmospherics/component/unary/shuttle/heater/examine(mob/user)
	. = ..()
	var/datum/gas_mixture/air_contents = airs[1]
	. += "The engine heater's gas dial reads [air_contents.return_volume()] liters in internal tank.<br>"

/obj/machinery/atmospherics/component/unary/shuttle/heater/proc/updateGasStats()
	var/datum/gas_mixture/air_contents = airs[1]
	if(!air_contents)
		return
...
/obj/machinery/atmospherics/component/unary/shuttle/heater/proc/hasFuel(var/required)
	var/datum/gas_mixture/air_contents = airs[1]
	var/moles = air_contents.total_moles()
	return moles >= required

/obj/machinery/atmospherics/component/unary/shuttle/heater/proc/consumeFuel(var/amount)
	var/datum/gas_mixture/air_contents = airs[1]
	air_contents.remove(amount)
	return

/obj/machinery/atmospherics/component/unary/shuttle/heater/attackby(obj/item/I, mob/living/user, params)
	update_adjacent_engines()
...
/obj/machinery/atmospherics/component/unary/shuttle/heater/proc/update_adjacent_engines()
	var/engine_turf
	switch(dir)
		if(NORTH)
