...
/obj/machinery/computer/cloning/process()
	...
	for(var/datum/data/record/R in records)
		...
		if(pod.growclone(R.fields["ckey"], R.fields["name"], R.fields["UI"], R.fields["mutations"], R.fields["mind"], R.fields["mrace"], R.fields["features"], R.fields["factions"], R.fields["quirks"]))
	...
	switch(src.menu)
		...
		if(3)
			...
			if (!src.active_record)
				...
				dat += "<b>Mutations:</b><br /><span class='highlight'>[src.active_record.fields["mutations"]]</span><br>"
	...
	if(href_list["task"])
		...
		if(C)
			...
			if(!LAZYLEN(pods))
				...
				playsound(src, 'sound/machines/terminal_prompt_deny.ogg', 50, 0)
			else if(pod.growclone(C.fields["ckey"], C.fields["name"], C.fields["UI"], C.fields["mutations"], C.fields["mind"], C.fields["mrace"], C.fields["features"], C.fields["factions"], C.fields["quirks"]))
...
/obj/machinery/computer/cloning/proc/scan_occupant(occupant)
	...
	R.fields["mutations"] = dna.mutation_index
