...
/obj/item/mecha_parts/mecha_equipment/medical/sleeper/proc/get_patient_dam()
	...
	return {"<font color="[patient.health > 50 ? "#3d5bc3" : "#c51e1e"]"><b>Health:</b> [patient.stat > 1 ? "[t1]" : "[patient.health]% ([t1])"]</font><br />
				<font color="[(patient.bodytemperature > patient.hypothermia_limit && patient.bodytemperature < patient.hyperthermia_limit) ? "#3d5bc3" : "#c51e1e"]"><b>Core Temperature:</b> [patient.bodytemperature-T0C]&deg;C ([patient.bodytemperature*1.8-459.67]&deg;F)</font><br />
