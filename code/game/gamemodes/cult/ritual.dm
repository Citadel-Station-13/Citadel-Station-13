...
/obj/item/weapon/tome/proc/read_tome(mob/user)
	...
	To do this, simply place the crew member upon the rune and invoke it. This rune requires one invokers to use. If the target to be converted is mindshield-implanted or a certain assignment, they will \
