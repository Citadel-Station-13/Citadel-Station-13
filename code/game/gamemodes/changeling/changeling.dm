...
GLOBAL_LIST_INIT(slot2slot, list("head" = INVENTORY_SLOT_HEAD, "wear_mask" = INVENTORY_SLOT_MASK, "neck" = INVENTORY_SLOT_NECK, "back" = INVENTORY_SLOT_BACK, "wear_suit" = INVENTORY_SLOT_OUTERWEAR, "w_uniform" = INVENTORY_SLOT_UNIFORM, "shoes" = INVENTORY_SLOT_SHOES, "belt" = INVENTORY_SLOT_BELT, "gloves" = INVENTORY_SLOT_GLOVES, "glasses" = INVENTORY_SLOT_GLASSES, "ears" = INVENTORY_SLOT_EARS, "wear_id" = INVENTORY_SLOT_ID_CARD, "s_store" = INVENTORY_SLOT_S_STORE))
