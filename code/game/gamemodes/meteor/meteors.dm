...
/obj/effect/meteor/meaty
	...
	meteordrop = list(/obj/item/reagent_containers/food/meat/slab/human, /obj/item/reagent_containers/food/meat/slab/human/mutant, /obj/item/organ/heart, /obj/item/organ/lungs, /obj/item/organ/tongue, /obj/item/organ/appendix/)
	var/meteorgibs = /obj/effect/gibspawner/generic
	threat = 2

/obj/effect/meteor/meaty/Initialize()
	for(var/path in meteordrop)
		if(path == /obj/item/reagent_containers/food/meat/slab/human/mutant)
			meteordrop -= path
...
/obj/effect/meteor/meaty/xeno
	color = "#5EFF00"
	meteordrop = list(/obj/item/reagent_containers/food/meat/slab/xeno, /obj/item/organ/tongue/alien)
