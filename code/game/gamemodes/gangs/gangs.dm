...
/datum/game_mode/gang
	...
	restricted_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Chief Engineer", "Chief Medical Officer", "Research Director", "Quartermaster", "AI", "Cyborg")
	required_players = 15
	required_enemies = 0
