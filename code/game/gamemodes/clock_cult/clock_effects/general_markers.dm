...
/obj/effect/clockwork/general_marker
	...
	clockwork_desc = "One of Mousevar's generals."
	alpha = 200
...
/obj/effect/clockwork/general_marker/inathneq
	...
	clockwork_desc = "One of Mousevar's four generals. Before her current form, Inath-neq was a powerful warrior priestess commanding the Resonant Cogs, a sect of Mousevarian warriors renowned for \
	their prowess. After a lost battle with Nar-Sian cultists, Inath-neq was struck down and stated in her dying breath, \
	\"The Resonant Cogs shall not fall silent this day, but will come together to form a wheel that shall never stop turning.\" Mousevar, touched by this, granted Inath-neq an eternal body and \
...
/obj/effect/clockwork/general_marker/nezbere
	...
	clockwork_desc = "One of Mousevar's four generals. Nezbere is responsible for the design, testing, and creation of everything in Mousevar's domain, and his loyalty to Mousevar knows no bounds. \
...
/obj/effect/clockwork/general_marker/sevtug
	...
	clockwork_desc = "One of Mousevar's four generals. Sevtug taught him how to manipulate minds and is one of his oldest allies. Sevtug serves Mousevar loyally out of a hope that one day, he will \
...
/obj/effect/clockwork/general_marker/nzcrentr
	...
	clockwork_desc = "One of Mousevar's four generals. Before becoming one of Mousevar's generals, Nzcrentr sook out any and all sentient life to slaughter it for sport. \
	Nzcrentr was coerced by Mousevar into entering a shell constructed by Nezbere, ostensibly made to grant Nzcrentr more power. In reality, the shell was made to trap and control it. \
