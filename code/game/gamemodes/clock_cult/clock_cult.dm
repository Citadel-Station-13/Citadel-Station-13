...
/datum/game_mode/proc/equip_servant(mob/living/M) //Grants a clockwork slab to the mob
	...
	var/list/slots = list("In your left pocket" = SLOT_L_STORE, "In your right pocket" = SLOT_R_STORE, "In your backpack" = SLOT_PUT_IN_BACKPACK)
	if(ishuman(L))
		var/mob/living/carbon/human/H = L
		var/obj/item/clockwork/replica_fabricator/F = new
		if(H.equip_to_slot_or_del(F, SLOT_PUT_IN_BACKPACK))
