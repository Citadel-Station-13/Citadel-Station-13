...
/datum/job/proc/special_check_latejoin(client/C)
	var/joined = LAZYLEN(C.persistent_variables?.characters_joined_as)
	if(C.persistent_variables?.respawn_restrictions_active && (joined || CONFIG_GET(flag/respawn_penalty_includes_observe)))
