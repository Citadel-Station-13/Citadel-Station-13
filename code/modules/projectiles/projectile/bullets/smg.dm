		...
		if(is_cleanable(A))
			...
			if(cleaned_human.lying)
				...
				if(cleaned_human.wear_suit)
					...
					if(istype(cleaned_human.w_underwear, /obj/item/clothing/underwear))
						var/obj/item/clothing/underwear/und = cleaned_human.w_underwear
						for(var/obj/item/clothing/underwear/U in und.appended)
							SEND_SIGNAL(U, COMSIG_COMPONENT_CLEAN_ACT, CLEAN_WEAK)
							U.clean_blood()
