...
/obj/item/ammo_box/magazine/r32acp
	name = "pistol magazine (.32 rubber)"
	desc = "A crudely construction pistol magazine that holds .32 ACP rubber rounds. It looks like it can only fit eight bullets."
	icon_state = "32acp"
