...
/obj/item/ammo_casing/shotgun/dart/noreact
	...
	desc = "A dart for use in shotguns, using similar technology as cryostasis beakers to keep internal reagents from reacting. Can be injected with up to 10 units of any chemical."
	icon_state = "cnrshell"
	reagent_amount = 10
	reagent_react = FALSE
