...
/obj/item/organ/stomach/on_life()
	...
	switch(deltapH)
		if(-INFINITY to 1)
			...
			C.apply_damage(0.8, BURN, C.get_bodypart(BODY_ZONE_CHEST))
			if(prob(10))
		...
		if(1 to 2.5)
			...
			C.apply_damage(0.4, BURN, C.get_bodypart(BODY_ZONE_CHEST))
			if(prob(10))
		...
		if(2.5 to 4)
			...
			if(prob(10))
				to_chat("You feel a mild burning discomfort in your stomach.")
		if(4 to 5.5)
