...
/obj/item/reagent_containers/food/snacks/baconegg
	...
	icon_state = "baconegg"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = 1, /datum/reagent/consumable/nutriment/vitamin = 1)
	list_reagents = list(/datum/reagent/consumable/protein = 5)
	bitesize = 2
	filling_color = "#FFFFF0"
...
/obj/item/reagent_containers/food/snacks/boiledegg
	...
	bonus_reagents = list(/datum/reagent/consumable/nutriment = 1, /datum/reagent/consumable/nutriment/vitamin = 1)
	filling_color = "#FFFFF0"
	list_reagents = list(/datum/reagent/consumable/protein = 2, /datum/reagent/consumable/nutriment/vitamin = 1)
	tastes = list("egg" = 1)
...
/obj/item/reagent_containers/food/snacks/omelette	//FUCK THIS
	...
	list_reagents = list(/datum/reagent/consumable/protein = 2, /datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/nutriment/vitamin = 1)
	bitesize = 1
...
/obj/item/reagent_containers/food/snacks/benedict
	...
	w_class = WEIGHT_CLASS_NORMAL
	trash = /obj/item/trash/plate
	list_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/protein = 4, /datum/reagent/consumable/nutriment/vitamin = 4)
...
/obj/item/reagent_containers/food/snacks/scotchegg
	...
	bonus_reagents = list(/datum/reagent/consumable/protein = 2, /datum/reagent/consumable/nutriment/vitamin = 2)
	bitesize = 3
	filling_color = "#FFFFF0"
