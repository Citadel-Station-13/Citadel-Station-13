...
/obj/item/food/condiment/update_icon_state()
	. = ..()
...
/obj/item/food/condiment/afterattack(obj/target, mob/user , proximity)
	. = ..()
	if(!proximity)
		return
...
/obj/item/food/condiment/enzyme/examine(mob/user)
	. = ..()
...
/obj/item/food/condiment/sugar/examine(mob/user)
	. = ..()
...
/obj/item/food/condiment/saltshaker //Separate from above since it's a small shaker rather then
...
/obj/item/food/condiment/saltshaker/suicide_act(mob/user)
...
/obj/item/food/condiment/saltshaker/afterattack(obj/target, mob/living/user, proximity)
	. = ..()
	if(!proximity)
		return
	if(isturf(target))
...
/obj/item/food/condiment/milk/examine(mob/user)
	. = ..()
	var/datum/chemical_reaction/recipe = GLOB.chemical_reactions_list[/datum/chemical_reaction/food/cheesewheel]
	var/milk_required = recipe.required_reagents[/datum/reagent/consumable/milk]
	var/enzyme_required = recipe.required_catalysts[/datum/reagent/consumable/enzyme]
...
/obj/item/food/condiment/flour/examine(mob/user)
	. = ..()
...
/obj/item/food/condiment/bbqsauce
	name = "bbq sauce"
	desc = "Hand wipes not included."
	icon_state = "bbqsauce"
	list_reagents = list(/datum/reagent/consumable/bbqsauce = 50)

/obj/item/food/condiment/soysauce
	name = "soy sauce"
...
/obj/item/food/condiment/mayonnaise
	name = "mayonnaise"
...
/obj/item/food/condiment/vinegar
	name = "vinegar"
...
/obj/item/food/condiment/quality_oil
	name = "quality oil"
...
/obj/item/food/condiment/pack/create_reagents(max_vol, flags)
	. = ..()
...
/obj/item/food/condiment/pack/update_icon()
	SHOULD_CALL_PARENT(FALSE)
	return

/obj/item/food/condiment/pack/attack(mob/M, mob/user, def_zone) //Can't feed these to people directly.
	return

/obj/item/food/condiment/pack/afterattack(obj/target, mob/user , proximity)
	if(!proximity)
		return
...
/obj/item/food/condiment/pack/proc/on_reagent_add(datum/reagents/reagents)
	SIGNAL_HANDLER
...
/obj/item/food/condiment/pack/proc/on_reagent_del(datum/reagents/reagents)
	SIGNAL_HANDLER
	icon_state = "condi_empty"
...
//Hot sauce
/obj/item/food/condiment/pack/hotsauce
	name = "hotsauce pack"
	originalname = "hotsauce"
	list_reagents = list(/datum/reagent/consumable/capsaicin = 10)

/obj/item/food/condiment/pack/astrotame
	name = "astrotame pack"
	originalname = "astrotame"
	list_reagents = list(/datum/reagent/consumable/astrotame = 5)

/obj/item/food/condiment/pack/bbqsauce
	name = "bbq sauce pack"
