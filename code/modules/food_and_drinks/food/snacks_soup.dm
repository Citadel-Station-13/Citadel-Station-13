...
/obj/item/reagent_containers/food/snacks/soup/wingfangchu
	...
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 6, /datum/reagent/consumable/soysauce = 5, /datum/reagent/consumable/nutriment/vitamin = 2)
	tastes = list("soy" = 1)
	foodtype = MEAT
...
/obj/item/reagent_containers/food/snacks/soup/bearchili
	...
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 10, /datum/reagent/medicine/morphine = 5, /datum/reagent/consumable/nutriment/vitamin = 2, /datum/reagent/consumable/capsaicin = 5)
...
/obj/item/reagent_containers/food/snacks/soup/monkeysdelight
	...
	bonus_reagents = list(/datum/reagent/consumable/nutriment = 1, /datum/reagent/consumable/nutriment/vitamin = 5)
	list_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/nutriment/protein = 5, /datum/reagent/consumable/banana = 5, /datum/reagent/consumable/nutriment/vitamin = 5)
...
/obj/item/reagent_containers/food/snacks/soup/tomato/eyeball
	...
	bonus_reagents = list(/datum/reagent/consumable/nutriment/protein = 1, /datum/reagent/liquidgibs = 3)
...
/obj/item/reagent_containers/food/snacks/soup/bisque
	...
	icon_state = "bisque"
	bonus_reagents = list(/datum/reagent/consumable/nutriment/protein = 4, /datum/reagent/consumable/nutriment/vitamin = 6)
...
/obj/item/reagent_containers/food/snacks/soup/facehuggerpot
	...
	bonus_reagents = list(/datum/reagent/consumable/nutriment = 1, /datum/reagent/consumable/nutriment/vitamin = 2)
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 20, /datum/reagent/consumable/nutriment/vitamin = 4)
