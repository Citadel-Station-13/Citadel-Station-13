...
/datum/chemical_reaction/food/chocolate_bar/on_reaction(datum/reagents/holder, multiplier)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= multiplier, i++)
...
/datum/chemical_reaction/food/chocolate_bar3	//chocolate bar 3 for some reason didn't have the mob react + reaction flag so I'm just adding it; name and ID also added; food dir added
	name = "Chocolate Bar"
	id = "chocolate_bar3"
...
/datum/chemical_reaction/drink/hot_coco	//wait are these drinks why are drinks in food I'm just gonna give them the drink dir
	name = "Hot Coco"
...
/datum/chemical_reaction/soysauce	//but these aren't drinks??? or a food??????
	name = "Soy Sauce"
...
/datum/chemical_reaction/food/corn_syrup	//THIS IS A FOOD???
	name = "corn_syrup"
...
/datum/chemical_reaction/food/margarine/on_reaction(datum/equilibrium/reaction, datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= multiplier, i++)
