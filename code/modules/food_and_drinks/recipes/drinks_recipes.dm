...
/datum/chemical_reaction/bepis
	name = "Bepis"
	id = "bepis"
	results = list("bepis" = 4)
	required_reagents = list("pepsi" = 2, "methamphetamine" = 1, "sugar" = 1)

/datum/chemical_reaction/pepsideluxe
	name = "Pepsi Deluxe"
	id = "pepsideluxe"
	results = list("pepsideluxe" = 1)
	required_reagents = list("pepsi" = 1, "gold" = 1)

/datum/chemical_reaction/endme
	name = "Endme"
	id = "endme"
	results = list("endme" = 2)
	required_reagents = list("pepsi" = 1, "cyanide" = 1)

/datum/chemical_reaction/pepe
	name = "Pepe"
	id = "pepe"
	results = list("pepe" = 10)
	required_reagents = list("pepsi" = 10, "capsaicin" = 1)

/datum/chemical_reaction/conk
	name = "Conk"
	id = "conk"
	results = list("conk" = 5)
	required_reagents = list("cola" = 1, "sacid" = 1, "cyanide" = 1, "formaldehyde" = 1, "sodiumchloride" = 1)

/datum/chemical_reaction/pepsimax
	name = "Pepsi Max"
	id = "pepsimax"
	results = list("pepsimax" = 6)
	required_reagents = list("pepsi" = 1, "bepis" = 1, "pepe" = 1, "endme" = 1, "pepsideluxe" = 1, "conk" = 1)

/datum/chemical_reaction/monster
	name = "Monster Energy"
	id = "monster"
	results = list("monster" = 6)
	required_reagents = list("pepsi" = 1, "coffee" = 1, "pwr_game" = 1, "sugar" = 1, "spacemountainwind" = 1, "dr_gibb" = 1)