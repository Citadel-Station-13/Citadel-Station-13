...
/obj/item/food/drinks/drinkingglass/on_reagent_change(datum/reagents/holder, ...)
	. = ..()
	if(!length(reagents.reagent_list))
		renamedByPlayer = FALSE //so new drinks can rename the glass

/obj/item/food/drinks/drinkingglass/update_name(updates)
	if(renamedByPlayer)
		return
	. = ..()
...
/obj/item/food/drinks/drinkingglass/update_desc(updates)
	if(renamedByPlayer)
		return
	. = ..()
	var/datum/reagent/largest_reagent = reagents.get_master_reagent()
...
/obj/item/food/drinks/drinkingglass/update_icon_state()
	if(!length(reagents.reagent_list))
		icon_state = "glass_empty"
		return ..()
...
/obj/item/food/drinks/drinkingglass/update_overlays()
	. = ..()
...
/obj/item/food/drinks/drinkingglass/shotglass/update_name(updates)
	if(renamedByPlayer)
		return
	. = ..()
	name = "[length(reagents.reagent_list) ? "filled " : null]shot glass"

/obj/item/food/drinks/drinkingglass/shotglass/update_desc(updates)
	if(renamedByPlayer)
		return
	. = ..()
	if(!length(reagents.reagent_list))
...
/obj/item/food/drinks/drinkingglass/shotglass/update_icon_state()
	. = ..()
	if(!length(reagents.reagent_list))
...
/obj/item/food/drinks/drinkingglass/shotglass/update_overlays()
	. = ..()
...
/obj/item/food/drinks/drinkingglass/filled/soda
	name = "Soda Water"
	list_reagents = list(/datum/reagent/consumable/sodawater = 50)

/obj/item/food/drinks/drinkingglass/filled/cola
	name = "Space Cola"
...
/obj/item/food/drinks/drinkingglass/attackby(obj/item/I, mob/user, params)
