...
/obj/item/food/drinks/attack(mob/living/M, mob/user, def_zone)
 ...
 */
/obj/item/food/drinks/on_accidental_consumption(mob/living/carbon/M, mob/living/carbon/user, obj/item/source_item,  discover_after = TRUE)
...
/obj/item/food/drinks/attackby(obj/item/I, mob/user, params)
...
/obj/item/food/drinks/throw_impact(atom/hit_atom, datum/thrownthing/throwingdatum)
	. = ..()
	if(!.) //if the bottle wasn't caught
		smash(hit_atom, throwingdatum?.thrower, TRUE)

/obj/item/food/drinks/proc/smash(atom/target, mob/thrower, ranged = FALSE)
	if(!isGlass)
		return
...
/obj/item/food/drinks/bullet_act(obj/projectile/P)
	. = ..()
...
/obj/item/food/drinks/trophy/gold_cup
	name = "gold cup"
	desc = "You're winner!"
...
/obj/item/food/drinks/trophy/silver_cup
	name = "silver cup"
	desc = "Best loser!"
...
/obj/item/food/drinks/trophy/bronze_cup
	name = "bronze cup"
...
/obj/item/food/drinks/ice/prison
	name = "dirty ice cup"
...
/obj/item/food/drinks/mug // parent type is literally just so empty mug sprites are a thing
	name = "mug"
...
/obj/item/food/drinks/mug/update_icon_state()
	icon_state = reagents.total_volume ? "tea" : "tea_empty"
	return ..()

/obj/item/food/drinks/mug/tea
	name = "Duke Purple tea"
	desc = "An insult to Duke Purple is an insult to the Space Queen! Any proper gentleman will fight you, if you sully this tea."
	list_reagents = list(/datum/reagent/consumable/tea = 30)

/obj/item/food/drinks/mug/coco
	name = "Dutch hot coco"
...
/obj/item/food/drinks/waterbottle
...
/obj/item/food/drinks/waterbottle/Initialize()
	. = ..()
...
/obj/item/food/drinks/waterbottle/update_overlays()
	. = ..()
	if(cap_on)
		. += cap_overlay

/obj/item/food/drinks/waterbottle/examine(mob/user)
	. = ..()
	if(cap_lost)
...
/obj/item/food/drinks/waterbottle/AltClick(mob/user)
	. = ..()
	if(cap_lost)
...
/obj/item/food/drinks/waterbottle/is_refillable()
	if(cap_on)
		return FALSE
	. = ..()

/obj/item/food/drinks/waterbottle/is_drainable()
	if(cap_on)
		return FALSE
	. = ..()

/obj/item/food/drinks/waterbottle/attack(mob/target, mob/living/user, def_zone)
	if(!target)
		return
...
/obj/item/food/drinks/waterbottle/afterattack(obj/target, mob/living/user, proximity)
	if(cap_on && (target.is_refillable() || target.is_drainable() || (reagents.total_volume && !user.combat_mode)))
		to_chat(user, span_warning("You must remove the cap before you can do that!"))
		return

	else if(istype(target, /obj/item/food/drinks/waterbottle))
		var/obj/item/food/drinks/waterbottle/WB = target
		if(WB.cap_on)
			to_chat(user, span_warning("[WB] has a cap firmly twisted on!"))
	. = ..()

// heehoo bottle flipping
/obj/item/food/drinks/waterbottle/throw_impact(atom/hit_atom, datum/thrownthing/throwingdatum)
	. = ..()
...
/obj/item/food/drinks/waterbottle/pickup(mob/user)
	. = ..()
	animate(src, transform = null, time = 1, loop = 0)

/obj/item/food/drinks/waterbottle/empty
	list_reagents = list()
	cap_on = FALSE

/obj/item/food/drinks/waterbottle/large
...
/obj/item/food/drinks/waterbottle/large/empty
	list_reagents = list()
	cap_on = FALSE

// Admin spawn
/obj/item/food/drinks/waterbottle/relic
...
/obj/item/food/drinks/waterbottle/relic/Initialize()
...
/obj/item/food/drinks/sillycup/update_icon_state()
	icon_state = reagents.total_volume ? "water_cup" : "water_cup_e"
	return ..()

/obj/item/food/drinks/sillycup/smallcarton
	name = "small carton"
...
/obj/item/food/drinks/sillycup/smallcarton/on_reagent_change(datum/reagents/holder, ...)
	. = ..()
...
/obj/item/food/drinks/sillycup/smallcarton/update_name(updates)
	. = ..()
	if(!length(reagents.reagent_list))
		name = "small carton"
		return
...
/obj/item/food/drinks/sillycup/smallcarton/update_desc(updates)
	. = ..()
	if(!length(reagents.reagent_list))
		desc = "A small carton, intended for holding drinks."
		return
...
/obj/item/food/drinks/sillycup/smallcarton/update_icon_state()
	. = ..()
	if(!length(reagents.reagent_list))
		icon_state = "juicebox"
		return
...
/obj/item/food/drinks/sillycup/smallcarton/smash(atom/target, mob/thrower, ranged = FALSE)
	if(bartender_check(target) && ranged)
		return
	var/obj/item/broken_bottle/B = new (loc)
	B.icon_state = icon_state
...
/obj/item/food/drinks/colocup/Initialize()
	.=..()
	pixel_x = rand(-4,4)
	pixel_y = rand(-4,4)
	if (random_sprite)
...
/obj/item/food/drinks/flask/gold
	name = "captain's flask"
	desc = "A gold flask belonging to the captain."
	icon_state = "flask_gold"
	custom_materials = list(/datum/material/gold=500)

/obj/item/food/drinks/flask/det
	name = "detective's flask"
	desc = "The detective's only true friend."
	icon_state = "detflask"
	list_reagents = list(/datum/reagent/consumable/ethanol/whiskey = 30)

/obj/item/food/drinks/britcup
	name = "cup"
...
/obj/item/food/drinks/soda_cans
	name = "soda can"
	lefthand_file = 'icons/mob/inhands/misc/food_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/misc/food_righthand.dmi'
	reagent_flags = NONE
...
/obj/item/food/drinks/soda_cans/random/Initialize()
	..()
	var/T = pick(subtypesof(/obj/item/food/drinks/soda_cans) - /obj/item/food/drinks/soda_cans/random)
	new T(loc)
	return INITIALIZE_HINT_QDEL

/obj/item/food/drinks/soda_cans/suicide_act(mob/living/carbon/human/H)
	if(!reagents.total_volume)
...
/obj/item/food/drinks/soda_cans/attack(mob/M, mob/living/user)
...
/obj/item/food/drinks/soda_cans/bullet_act(obj/projectile/P)
	. = ..()
	if(!(P.nodamage) && P.damage_type == BRUTE && !QDELETED(src))
...
/obj/item/food/drinks/soda_cans/proc/open_soda(mob/user)
	to_chat(user, "You pull back the tab of \the [src] with a satisfying pop.") //Ahhhhhhhh
	reagents.flags |= OPENCONTAINER
	playsound(src, "can_open", 50, TRUE)
	spillable = TRUE

/obj/item/food/drinks/soda_cans/attack_self(mob/user)
	if(!is_drainable())
		open_soda(user)
		return
	return ..()

/obj/item/food/drinks/soda_cans/attack_self_secondary(mob/user)
	if(!is_drainable())
		open_soda(user)
		return
	return ..()
...
/obj/item/food/drinks/soda_cans/tonic
...
/obj/item/food/drinks/soda_cans/sodawater
	name = "soda water"
...
/obj/item/food/drinks/soda_cans/lemon_lime/Initialize()
	. = ..()
	name = "lemon-lime soda"

/obj/item/food/drinks/soda_cans/sol_dry
	name = "Sol Dry"
...
/obj/item/food/drinks/soda_cans/thirteenloko
	name = "Thirteen Loko"
...
/obj/item/food/drinks/soda_cans/shamblers
...
/obj/item/food/drinks/soda_cans/grey_bull
	name = "Grey Bull"
...
/obj/item/food/drinks/soda_cans/monkey_energy
	name = "Monkey Energy"
...
/obj/item/food/drinks/soda_cans/air
	name = "canned air"
