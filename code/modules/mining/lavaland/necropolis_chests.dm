...
/obj/item/dragons_blood/attack_self(mob/living/carbon/human/user)
	...
	switch(random)
		if(1)
			...
			H.dna.features = list(FEAT_MUTCOLOR = "A02720", FEAT_TAIL_LIZARD = "Dark Tiger", FEAT_TAIL_HUMAN = "None", FEAT_SNOUT = "Sharp", FEAT_HORNS = "Curled", FEAT_EARS = "None", FEAT_WINGS = "None", FEAT_FRILLS = "None", FEAT_SPINES = "Long", FEAT_MARKINGS = "Dark Tiger Body", FEAT_LEGS = "Digitigrade")
			H.eye_color = "fee5a3"
