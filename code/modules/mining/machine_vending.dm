...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
        ...
        //new /datum/data/mining_equipment("Kinetic Detonator",           /obj/item/kinetic_crusher/premium,                                  12000), //Its powerful. VERY powerful
		)
...
/obj/machinery/mineral/equipment_vendor/proc/RedeemSVoucher(obj/item/suit_voucher/voucher, mob/redeemer)
	...
	switch(selection)
		if("Exo-suit")
			new /obj/item/clothing/suit/hooded/explorer/exo/standard(drop_location)
			new /obj/item/clothing/mask/gas/exo(drop_location)
		if("SEVA suit")
			new /obj/item/clothing/suit/hooded/explorer/seva/standard(drop_location)
			new /obj/item/clothing/mask/gas/seva(drop_location)
		if("Explorer suit")
			new /obj/item/clothing/suit/hooded/explorer/standard(drop_location)
