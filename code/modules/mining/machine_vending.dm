...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list(
		...
		new /datum/data/mining_equipment("Survival Medipen",	/obj/item/weapon/reagent_containers/hypospray/medipen/survival,			400),
		...
		new /datum/data/mining_equipment("Survival bundle",		/obj/item/weapon/storage/box/medipens/utility1,	 				  		800),
