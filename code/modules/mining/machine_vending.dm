...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Whiskey",						/obj/item/food/reagent_containers/drinks/bottle/whiskey,			100),
		new /datum/data/mining_equipment("Absinthe",					/obj/item/food/reagent_containers/drinks/bottle/absinthe/premium,	100),
...
/obj/machinery/mineral/equipment_vendor/golem/Initialize()
	...
	prize_list += list(
		...
		new /datum/data/mining_equipment("Monkey Cube",					/obj/item/food/cube/monkey,        	300),
