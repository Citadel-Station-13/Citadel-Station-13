...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Stimpack",			/obj/item/weapon/reagent_containers/hypospray/medipen/stimpack(src),	250),
		new /datum/data/mining_equipment("Stimpack Value Pack", /obj/item/weapon/storage/box/medipens/utility,							750),
		new /datum/data/mining_equipment("Survival Pen Value Pack", /obj/item/weapon/storage/box/medipens/utilityS						2500),
		)
