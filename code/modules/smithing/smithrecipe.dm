...
/datum/smith_recipe
	...
	var/list/planlaststeps = list(STEP_LAST = null, STEP_SECOND_LAST = null, STEP_THIRD_LAST = null)
...
/datum/smith_recipe/scimitar
	...
	planlaststeps = list(STEP_LAST = STEP_BEND, STEP_SECOND_LAST = STEP_HIT_MODERATE, STEP_THIRD_LAST = STEP_HIT_MODERATE)
	laststepsneeded = 2
...
/datum/smith_recipe/rapier
	...
	planlaststeps = list(STEP_LAST = STEP_DRAW, STEP_SECOND_LAST = STEP_UPSET, STEP_THIRD_LAST = STEP_FOLD)
	target_height_min = 2
	target_height_perfect = 4
	target_height_max = 8
	output_type = /obj/item/smithing/rapierblade

/datum/smith_recipe/broadsword
	displayname = "broadsword blade"
	planlaststeps = list(STEP_LAST = STEP_HIT_LIGHT, STEP_SECOND_LAST = STEP_BEND, STEP_THIRD_LAST = STEP_BEND)
...
/datum/smith_recipe/katana
	...
	planlaststeps = list(STEP_LAST = STEP_FOLD, STEP_SECOND_LAST = STEP_FOLD, STEP_THIRD_LAST = STEP_FOLD)
	target_height_min = 8
	target_height_perfect = 12
	target_height_max = 14
...
/datum/smith_recipe/javelin
	...
	planlaststeps = list(STEP_LAST = STEP_HIT_LIGHT, STEP_SECOND_LAST = STEP_HIT_LIGHT, STEP_THIRD_LAST = STEP_DRAW)
...
/datum/smith_recipe/pike
	...
	planlaststeps = list(STEP_LAST = STEP_HIT_HEAVY, STEP_SECOND_LAST = STEP_DRAW, STEP_THIRD_LAST = STEP_DRAW)
	target_height_min = 24
	target_height_perfect = 26
	target_height_max = 30
...
/datum/smith_recipe/mining
	...
	planlaststeps = list(STEP_LAST = STEP_PUNCH, STEP_SECOND_LAST = STEP_BEND, STEP_THIRD_LAST = STEP_DRAW)
...
/datum/smith_recipe/miningscanner
	...
	planlaststeps = list(STEP_LAST = STEP_PUNCH, STEP_SECOND_LAST = STEP_DRAW, STEP_THIRD_LAST = STEP_BEND)
	laststepsneeded = 2
	target_height_min = 24
	target_height_perfect = 26
...
/datum/smith_recipe/cogheadclub
	...
	planlaststeps = list(STEP_LAST = STEP_PUNCH, STEP_SECOND_LAST = STEP_HIT_HEAVY, STEP_THIRD_LAST = STEP_UPSET)
...
/datum/smith_recipe/scytheblade
	...
	planlaststeps = list(STEP_LAST = STEP_HIT_MODERATE, STEP_SECOND_LAST = STEP_BEND, STEP_THIRD_LAST = STEP_BEND)
...
/datum/smith_recipe/hammerhead
	...
	planlaststeps = list(STEP_LAST = STEP_PUNCH, STEP_SECOND_LAST = STEP_UPSET, STEP_THIRD_LAST = STEP_UPSET)
