...
/obj/item/shield/riot/ratvarian
	...
	max_integrity = 100
	var/repair_material = NULL // Done differently because brass is technically a floortile, not a material sheet.
	var/dam_absorbed = 0
...
/obj/item/shield/ratvarian/user_shieldbash(mob/living/user, atom/target, harmful)
