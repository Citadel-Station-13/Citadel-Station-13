...
/obj/item/clothing/head/helmet/clockwork
	...
	inventory_hide_flags = HIDEEARS|HIDEHAIR|HIDEFACE|HIDESNOUT
...
/obj/item/clothing/head/helmet/clockwork/equipped(mob/living/user, slot)
	..()
	if(slot == INVENTORY_SLOT_HEAD && !is_servant_of_ratvar(user))
		if(!iscultist(user))
...
/obj/item/clothing/suit/armor/clockwork/equipped(mob/living/user, slot)
	..()
	if(slot == INVENTORY_SLOT_OUTERWEAR && !is_servant_of_ratvar(user))
		if(!iscultist(user))
			to_chat(user, "<span class='heavy_brass'>\"Now now, this is for my servants, not you.\"</span>")
...
/obj/item/clothing/gloves/clockwork/equipped(mob/living/user, slot)
	..()
	if(slot == INVENTORY_SLOT_GLOVES && !is_servant_of_ratvar(user))
		if(!iscultist(user))
			to_chat(user, "<span class='heavy_brass'>\"Now now, this is for my servants, not you.\"</span>")
...
/obj/item/clothing/shoes/clockwork/equipped(mob/living/user, slot)
	..()
	if(slot == INVENTORY_SLOT_SHOES && !is_servant_of_ratvar(user))
		if(!iscultist(user))
			to_chat(user, "<span class='heavy_brass'>\"Now now, this is for my servants, not you.\"</span>")
