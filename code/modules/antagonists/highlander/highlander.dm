...
/datum/antagonist/highlander/proc/give_equipment()
	...
	for(var/obj/item/I in H.held_items)
		qdel(I)
	H.equip_to_slot_or_del(new /obj/item/clothing/under/costume/kilt/highlander(H), INVENTORY_SLOT_UNIFORM)
	H.equip_to_slot_or_del(new /obj/item/radio/headset/heads/captain(H), INVENTORY_SLOT_EARS)
	H.equip_to_slot_or_del(new /obj/item/clothing/head/beret/highlander(H), INVENTORY_SLOT_HEAD)
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/combat(H), INVENTORY_SLOT_SHOES)
	H.equip_to_slot_or_del(new /obj/item/pinpointer/nuke(H), INVENTORY_SLOT_L_STORE)
	...
	H.equip_to_slot_or_del(W, INVENTORY_SLOT_ID_CARD)
