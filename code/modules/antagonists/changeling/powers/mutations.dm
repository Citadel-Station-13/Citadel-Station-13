...
/obj/effect/proc_holder/changeling/suit/sting_action(mob/living/carbon/human/user)
	...
	user.equip_to_slot_if_possible(new suit_type(user), INVENTORY_SLOT_OUTERWEAR, 1, 1, 1)
	user.equip_to_slot_if_possible(new helmet_type(user), INVENTORY_SLOT_HEAD, 1, 1, 1)
