...
/obj/item/clothing/suit/space/hardsuit/clown/mob_can_equip(mob/living/M, mob/living/equipper, slot, disable_warning = FALSE, bypass_equip_delay_self = FALSE, clothing_check = FALSE, list/return_warning)
	if(!..() || !ishuman(M))
		return FALSE
