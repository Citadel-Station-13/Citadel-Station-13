/obj/item/clothing/under/rank/engineering
	...
	anthro_mob_worn_overlay = 'icons/mob/clothing/under/engineering_digi.dmi'
	icon_state = "engine"
	item_state = "engi_suit"
	armor = list(MELEE = 0, BULLET = 0, LASER = 0,ENERGY = 0, BOMB = 0, BIO = 0, RAD = 10, FIRE = 60, ACID = 20, WOUND = 5)
	resistance_flags = NONE

/obj/item/clothing/under/rank/engineering/skirt
...
/obj/item/clothing/under/rank/engineering/hazard/green
	icon_state = "hazard_green"
	item_state = "g_suit"

/obj/item/clothing/under/rank/engineering/hazard/white
...
/obj/item/clothing/under/rank/engineering/util
