/obj/item/clothing/under/rank/medical
	...
	anthro_mob_worn_overlay = 'icons/mob/clothing/under/medical_digi.dmi'
	icon_state = "medical"
	item_state = "w_suit"
...
/obj/item/clothing/under/rank/medical/util
...
/obj/item/clothing/under/rank/medical/virologist
	...
	icon_state = "virology"
	item_state = "w_suit"
	armor = list(MELEE = 0, BULLET = 0, LASER = 0,ENERGY = 0, BOMB = 0, BIO = 20, RAD = 0, FIRE = 0, ACID = 0, WOUND = 5)
...
/obj/item/clothing/under/rank/medical/paramedic/red
	...
	icon_state = "paramedic_red"
	item_state = "paramedic_red"
	can_adjust = FALSE
