...
/obj/item/clothing/under/syndicate/bloodred
	...
	item_state = "bl_suit"
	dummy_thick = TRUE
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10,"energy" = 10, "bomb" = 0, "bio" = 0, "rad" = 10, "fire" = 50, "acid" = 40, "wound" = 5)
...
/obj/item/clothing/under/syndicate/baseball
	...
	has_sensor = NO_SENSORS
	armor = list("melee" = 15, "bullet" = 5, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 40, "wound" = 5)
	alt_covers_chest = TRUE
	mutantrace_variation = USE_TAUR_CLIP_MASK
