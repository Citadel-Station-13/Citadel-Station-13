	...
	switch(href_list["task"])
		...
		if("input")
			...
			switch(href_list["preference"])
				...
				if("protogen_screens")
					var/new_protogen_screens
					new_protogen_screens = input(user, "Choose your character's screen:", "Character Preference") as null|anything in GLOB.protogen_screens_list
					if(new_protogen_screens)
						features["protogen_screens"] = new_protogen_screens
