			...
			for (var/i in GLOB.special_roles)
				if(jobban_isbanned(user, i))
					...
					if(days_remaining)
						...
						dat += "<b>[i == ROLE_SYNDICATE? "DISABLE ALL ANTAGONISM" : "Be [capitalize(i)]"]:</b> <a href='?_src_=prefs;preference=be_special;be_special_type=[i]'>[(i in be_special) ? "Enabled" : "Disabled"]</a><br>"
