...
/client/proc/force_white_theme() //There's no way round it. We're essentially changing the skin by hand. It's painful but it works, and is the way Lummox suggested.
	...
	winset(src, "say", "background-color = [COLOR_DARKMODE_BACKGROUND];background-color = none")
	winset(src, "say", "text-color = [COLOR_DARKMODE_TEXT];text-color = #000000")
...
/client/proc/force_dark_theme() //Inversely, if theyre using white theme and want to swap to the superior dark theme, let's get WINSET() ing
	...
	//Say, OOC, me Buttons etc.
	winset(src, "say", "background-color = none;background-color = [COLOR_DARKMODE_BACKGROUND]")
	winset(src, "say", "text-color = #000000;text-color = [COLOR_DARKMODE_TEXT]")
