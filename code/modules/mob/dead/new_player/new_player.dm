...
/mob/dead/new_player/proc/make_me_an_observer()
	...
	observer.client.persistent_variables?.respawn_time_of_death = world.time
...
/mob/dead/new_player/proc/AttemptLateSpawn(rank)
	...
	LAZYOR(character.client.persistent_variables.slots_joined_as, character.client.prefs.default_slot)
	LAZYOR(character.client.persistent_variables.characters_joined_as, character.real_name)
