...
/mob/proc/put_in_hand(obj/item/I, hand_index, forced = FALSE, ignore_anim = TRUE)
	if(forced || can_put_in_hand(I, hand_index))
		...
		I.equipped(src, INVENTORY_SLOT_PUT_IN_HANDS)
		if(I.pulledby)
...
/obj/item/proc/equip_to_best_slot(mob/M)
	...
	var/list/obj/item/possible = list(M.get_inactive_held_item(), M.get_item_in_slot(INVENTORY_SLOT_BELT), M.get_item_in_slot(INVENTORY_SLOT_GENERC_DEXTROUS_STORAGE), M.get_item_in_slot(INVENTORY_SLOT_BACK))
