/mob/living/carbon/human
	...
	inventory_slots_default = list(
		...
		INVENTORY_SLOT_OUTERWEAR,
		INVENTORY_SLOT_UNIFORM,
		INVENTORY_SLOT_S_STORE,
		INVENTORY_SLOT_L_STORE,
		INVENTORY_SLOT_R_STORE,
		INVENTORY_SLOT_GLOVES,
		INVENTORY_SLOT_GLASSES,
		INVENTORY_SLOT_EARS,
		INVENTORY_SLOT_NECK,
		INVENTORY_SLOT_SHOES,
		INVENTORY_SLOT_MASK,
		INVENTORY_SLOT_BELT,
		INVENTORY_SLOT_ID_CARD
	)
