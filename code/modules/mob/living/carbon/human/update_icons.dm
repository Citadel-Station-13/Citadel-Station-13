	...
	if(istype(w_uniform, /obj/item/clothing/under))
		...
		if(dna && dna.species.sexes)
			...
			if(G == "f" && U.fitted != NO_FEMALE_UNIFORM)
				uniform_overlay = U.build_worn_icon(state = "[t_color]", default_layer = UNIFORM_LAYER, default_icon_file = ((w_uniform.snowflake_sprites && dna && dna.species && dna.species.mutant_bodyparts && dna.features && w_uniform.snowflake_type in dna.species.mutant_bodyparts && dna.features["[w_uniform.snowflake_type]"] in w_uniform.snowflake_sprites) ? w_uniform.snowflake_sprites[dna.features["[w_uniform.snowflake_type]"]] : 'icons/mob/uniform.dmi'), isinhands = FALSE, femaleuniform = U.fitted)

		if(!uniform_overlay)
			uniform_overlay = U.build_worn_icon(state = "[t_color]", default_layer = UNIFORM_LAYER, default_icon_file = ((w_uniform.snowflake_sprites && dna && dna.species && dna.species.mutant_bodyparts && dna.features && w_uniform.snowflake_type in dna.species.mutant_bodyparts && dna.features["[w_uniform.snowflake_type]"] in w_uniform.snowflake_sprites) ? w_uniform.snowflake_sprites[dna.features["[w_uniform.snowflake_type]"]] : 'icons/mob/uniform.dmi'), isinhands = FALSE)
...
/mob/living/carbon/human/update_inv_s_store()
	...
	if(s_store)
		...
		overlays_standing[SUIT_STORE_LAYER]	= mutable_appearance(((s_store.snowflake_sprites && dna && dna.species && dna.species.mutant_bodyparts && dna.features && s_store.snowflake_type in dna.species.mutant_bodyparts && dna.features["[s_store.snowflake_type]"] in s_store.snowflake_sprites) ? s_store.snowflake_sprites[dna.features["[s_store.snowflake_type]"]] : 'icons/mob/belt_mirror.dmi'), t_state, -SUIT_STORE_LAYER)
