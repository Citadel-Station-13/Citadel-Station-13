...
/mob/living/carbon/human/PhysicalLife(seconds, times_fired)
	...
	if(ckey in list("silicons", "cygnusb", "putnam", "r3dtaile", "deltafire", "r0-adic", "xantholne", "trojancoyote", "dzahlus", "nicodeimos", "deathride58", "bluewildrose", "roguesteampunker", "linzolle")) // Don't know if nico is still an admin, don't have an admin list anywhere so feel free to add if there's people missing
