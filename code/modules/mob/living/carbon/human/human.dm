...
/mob/living/carbon/human/ComponentInitialize()
	...
	AddElement(/datum/element/flavor_text/carbon, _name = "OOC Notes", _addendum = "Put information on ERP/vore/lewd-related preferences here. THIS SHOULD NOT CONTAIN REGULAR FLAVORTEXT!!", _always_show = TRUE, _save_key = "ooc_notes", _dna_carryover = FALSE)
