/datum/species/insect
	...
	species_traits = list(LIPS, EYECOLOR,HAIR, FACEHAIR, MUTCOLORS, WINGCOLOR)
	inherent_biotypes = list(MOB_ORGANIC, MOB_HUMANOID, MOB_BUG)
	randomized_features = list(FEAT_INSECT_WINGS, FEAT_INSECT_FLUFF, FEAT_INSECT_MARKINGS, FEAT_MUTCOLOR)
	mutant_bodyparts = list(FEAT_MAM_EARS, FEAT_MAM_SNOUT, FEAT_TAIL_MAM, FEAT_TAUR, FEAT_INSECT_WINGS, FEAT_MAM_SNOUT, FEAT_INSECT_FLUFF, FEAT_INSECT_MARKINGS)
	default_features = list(FEAT_MUTCOLOR = "FFF",FEAT_MUTCOLOR2 = "FFF",FEAT_MUTCOLOR3 = "FFF", FEAT_TAIL_MAM = "None", FEAT_MAM_EARS = "None",
							FEAT_INSECT_WINGS = "None", FEAT_INSECT_FLUFF = "None", FEAT_MAM_SNOUT = "None", FEAT_TAUR = "None", FEAT_INSECT_MARKINGS = "None")
	attack_verb = "slash"
