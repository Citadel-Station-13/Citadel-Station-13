/datum/species/plasmaman
	...
	species_traits = list(NOBLOOD,RESISTCOLD,RADIMMUNE,NOTRANSSTING,VIRUSIMMUNE,NOHUNGER,NO_BONES) //Nobones for now. Will be giving them a regent to regen bones.
