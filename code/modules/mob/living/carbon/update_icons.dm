...
/mob/living/carbon/update_inv_wear_mask()
	...
	if(wear_mask)
		if(!(head && (head.flags_inv & HIDEMASK)))
			overlays_standing[FACEMASK_LAYER] = wear_mask.build_worn_icon(state = wear_mask.icon_state, default_layer = FACEMASK_LAYER, default_icon_file = (wear_mask.snowflake_sprites && dna && dna.species && dna.species.mutant_bodyparts && dna.features && wear_mask.snowflake_type in dna.species.mutant_bodyparts && dna.features["[wear_mask.snowflake_type]"] in wear_mask.snowflake_sprites) ? wear_mask.snowflake_sprites[dna.features["[wear_mask.snowflake_type]"]] : ((wear_mask.icon_override) ? wear_mask.icon_override : 'icons/mob/mask.dmi')))
...
/mob/living/carbon/update_inv_neck()
	...
	if(wear_neck)
		if(!(head && (head.flags_inv & HIDENECK)))
			overlays_standing[NECK_LAYER] = wear_neck.build_worn_icon(state = wear_neck.icon_state, default_layer = NECK_LAYER, default_icon_file = (wear_neck.snowflake_sprites && dna && dna.species && dna.species.mutant_bodyparts && dna.features && wear_neck.snowflake_type in dna.species.mutant_bodyparts && dna.features["[wear_neck.snowflake_type]"] in wear_neck.snowflake_sprites) ? wear_neck.snowflake_sprites[dna.features["[wear_neck.snowflake_type]"]] : ((wear_neck.icon_override) ? wear_neck.icon_override : 'icons/mob/neck.dmi')))
...
/mob/living/carbon/update_inv_back()
	...
	if(back)
		overlays_standing[BACK_LAYER] = back.build_worn_icon(state = back.icon_state, default_layer = BACK_LAYER, default_icon_file = (back.snowflake_sprites && dna && dna.species && dna.species.mutant_bodyparts && dna.features && back.snowflake_type in dna.species.mutant_bodyparts && dna.features["[back.snowflake_type]"] in back.snowflake_sprites) ? back.snowflake_sprites[dna.features["[back.snowflake_type]"]] : ((back.icon_override) ? back.icon_override : 'icons/mob/back.dmi')))
...
/mob/living/carbon/update_inv_head()
	...
	if(head)
		overlays_standing[HEAD_LAYER] = head.build_worn_icon(state = head.icon_state, default_layer = HEAD_LAYER, default_icon_file = (head.snowflake_sprites && dna && dna.species && dna.species.mutant_bodyparts && dna.features && head.snowflake_type in dna.species.mutant_bodyparts && dna.features["[head.snowflake_type]"] in head.snowflake_sprites) ? head.snowflake_sprites[dna.features["[head.snowflake_type]"]] : ((head.icon_override) ? head.icon_override : 'icons/mob/head.dmi')))
