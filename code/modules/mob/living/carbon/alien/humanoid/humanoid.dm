...
/mob/living/carbon/alien/humanoid/show_inv(mob/user)
	...
	for(var/i in 1 to held_items.len)
		...
		dat += "<BR><B>[get_held_index_name(i)]:</B><A href='?src=[REF(src)];item=[INVENTORY_SLOT_PUT_IN_HANDS];hand_index=[i]'>[(I && !(I.item_flags & ABSTRACT)) ? I : "<font color=grey>Empty</font>"]</a>"
