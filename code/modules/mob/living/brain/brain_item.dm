/obj/item/organ/brain
	...
	decay_factor = STANDARD_ORGAN_DECAY	/ 5		//30 minutes of decaying to result in a fully damaged brain, since a fast decay rate would be unfun gameplay-wise
...
/obj/item/organ/brain/decay()
	...
	if(damage > high_threshold) //Stops brains from fully decaying
		return
	if(owner.has_reagent("cyrosenium"))
		return
	is_cold()
