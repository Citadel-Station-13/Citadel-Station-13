...
/mob/living/simple_animal/hostile/bear
	...
	turns_per_move = 5
	see_in_dark = 6
	butcher_results = list(/obj/item/reagent_containers/food/meat/slab/bear = 5, /obj/item/clothing/head/bearpelt = 1)
...
/mob/living/simple_animal/hostile/bear/russian
	...
	faction = list("russian")
	butcher_results = list(/obj/item/reagent_containers/food/meat/slab/bear = 5, /obj/item/clothing/head/bearpelt = 1, /obj/item/bear_armor = 1)
...
/mob/living/simple_animal/hostile/bear/butter //The mighty companion to Cak. Several functions used from it.
	...
	butcher_results = list(/obj/item/reagent_containers/food/butter = 6, /obj/item/reagent_containers/food/meat/slab = 3, /obj/item/organ/brain = 1, /obj/item/organ/heart = 1)
