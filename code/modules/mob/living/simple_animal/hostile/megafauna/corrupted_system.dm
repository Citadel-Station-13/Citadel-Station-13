...
/obj/item/gps/internal/corrupted_system
	icon_state = null
...
/mob/living/simple_animal/hostile/megafauna/corrupted_system/Initialize()
	. = ..()
	internal = new /obj/item/gps/internal/corrupted_system(src)
