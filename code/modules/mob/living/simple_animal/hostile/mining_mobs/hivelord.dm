...
/obj/effect/mob_spawn/human/corpse/damaged/legioninfested/Initialize(mapload)
	...
	switch(type)
		if("Miner")
			...
			mask = /obj/item/clothing/mask/gas/explorer
			if(prob(20))
				suit = pickweight(list(/obj/item/clothing/suit/hooded/explorer/standard = 6, /obj/item/clothing/suit/hooded/explorer/heva = 6, /obj/item/clothing/suit/hooded/cloak/goliath = 2))
			if(prob(30))
