...
/obj/effect/mob_spawn/human/corpse/damaged/legioninfested/Initialize()
	...
	switch(type)
		...
		if("Clown")
			...
			if(prob(70))
				backpack_contents += pick(list(/obj/item/stamp/clown = 1, /obj/item/reagent_containers/spray/waterflower = 1, /obj/item/food/grown/banana = 1, /obj/item/megaphone/clown = 1, /obj/item/food/reagent_containers/drinks/soda_cans/canned_laughter = 1, /obj/item/pneumatic_cannon/pie = 1))
			if(prob(30))
		...
		if("Beelegion")
			...
			id_job = "Assisant"
			id = /obj/item/card/id
			l_pocket = /obj/item/food/reagent_containers/drinks/soda_cans/buzz_fuzz
