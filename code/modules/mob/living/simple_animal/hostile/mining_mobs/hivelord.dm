...
/obj/effect/mob_spawn/human/corpse/damaged/legioninfested/Initialize()
	...
	switch(type)
		if("Miner")
			...
			mask = /obj/item/clothing/mask/gas/explorer
			if(prob(20))
				suit = pickweight(list(/obj/item/clothing/suit/hooded/explorer/standard = 6, /obj/item/clothing/suit/hooded/cloak/goliath = 2, /obj/item/clothing/suit/hooded/explorer/exo/standard = 6, /obj/item/clothing/suit/hooded/explorer/seva/standard = 6))
			if(prob(30))
