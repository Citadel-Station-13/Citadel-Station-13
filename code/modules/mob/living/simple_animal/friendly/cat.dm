...
/mob/living/simple_animal/pet/cat
	...
	butcher_results = list(/obj/item/reagent_containers/food/meat/slab = 2, /obj/item/organ/ears/cat = 1, /obj/item/organ/tail/cat = 1)
...
/mob/living/simple_animal/pet/cat/cak //I told you I'd do it, Remie
	...
	butcher_results = list(/obj/item/organ/brain = 1, /obj/item/organ/heart = 1, /obj/item/reagent_containers/food/cakeslice/birthday = 3,  \
	/obj/item/reagent_containers/food/meat/slab = 2)
...
/mob/living/simple_animal/pet/cat/cak/BiologicalLife(seconds, times_fired)
	...
	for(var/obj/item/reagent_containers/food/donut/D in range(1, src)) //Frosts nearby donuts!
		if(!D.is_decorated)
			D.decorate_donut()
