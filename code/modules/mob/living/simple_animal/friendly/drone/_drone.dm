...
/mob/living/simple_animal/drone/ComponentInitialize()
	...
	if(can_be_held)
		...
		AddElement(/datum/element/mob_holder, null, 'icons/mob/clothing/head.dmi', 'icons/mob/inhands/clothing_righthand.dmi', 'icons/mob/inhands/clothing_lefthand.dmi', SLOT_FLAG_HEAD, /datum/element/mob_holder.proc/drone_worn_icon)
