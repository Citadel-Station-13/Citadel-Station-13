...
/mob/living/silicon/robot/proc/uneq_module(obj/item/O)
	...
	if(istype(O,/obj/item/gun/energy/laser/cyborg))
		laser = FALSE
		update_icons()
	else if(istype(O,/obj/item/gun/energy/disabler/cyborg) || istype(/obj/item/gun/energy/e_gun/advtaser/cyborg))
		disabler = FALSE
...
/mob/living/silicon/robot/proc/activate_module(obj/item/O)
	...
	if(istype(O,/obj/item/gun/energy/disabler/cyborg) || istype(/obj/item/gun/energy/e_gun/advtaser/cyborg))
		disabler = TRUE
		update_icons()
	//END CITADEL EDIT
	if(activated(O))
