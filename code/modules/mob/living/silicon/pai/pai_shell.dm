...
/mob/living/silicon/pai/proc/choose_chassis()
	...
	if(possible_chassis[old_chassis])
		var/datum/element/mob_holder/M = GetElement(/datum/element/mob_holder, old_chassis, 'icons/mob/pai_item_head.dmi', 'icons/mob/pai_item_rh.dmi', 'icons/mob/pai_item_lh.dmi', ITEM_SLOT_HEAD)
		M.Detach(src)
