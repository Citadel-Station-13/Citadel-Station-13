...
/mob/living/silicon/pai/proc/initialize_dynamic_chassis_icons()
	...
	.["Cyborg - Engineering (loaderborg)"] = process_holoform_icon_filter(icon('icons/mob/robots_citadel.dmi', "loaderborg"), HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Engineering (handyeng)"] = process_holoform_icon_filter(icon('icons/mob/robots_citadel.dmi', "handyeng"), HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Engineering (sleekeng)"] = process_holoform_icon_filter(icon('icons/mob/robots_citadel.dmi', "sleekeng"), HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Engineering (marinaeng)"] = process_holoform_icon_filter(icon('icons/mob/robots_citadel.dmi', "marinaeng"), HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Medical (default)"] = process_holoform_icon_filter(icon('icons/mob/robots.dmi', "medical"), HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Medical (marinamed)"] = process_holoform_icon_filter(icon('icons/mob/robots_citadel.dmi', "marinamed"), HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Medical (eyebotmed)"] = process_holoform_icon_filter(icon('icons/mob/robots_citadel.dmi', "eyebotmed"), HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Security (default)"] = process_holoform_icon_filter(icon('icons/mob/robots.dmi', "sec"), HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Security (sleeksec)"] = process_holoform_icon_filter(icon('icons/mob/robots_citadel.dmi', "sleeksec"), HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Security (marinasec)"] = process_holoform_icon_filter(icon('icons/mob/robots_citadel.dmi', "marinasec"), HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Clown (default)"] = process_holoform_icon_filter(icon('icons/mob/robots.dmi', "clown"), HOLOFORM_FILTER_PAI, FALSE)

	//Citadel dogborgs
	//Engi
	curr = icon('icons/mob/widerobot.dmi', "valeeng")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valeeng-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valeeng-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valeeng-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Engineering (dog - valeeng)"] = curr
	curr = icon('icons/mob/widerobot.dmi', "pupdozer")
	curr.Insert(icon('icons/mob/widerobot.dmi', "pupdozer-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "pupdozer-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "pupdozer-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Engineering (dog - pupdozer)"] = curr
	//Med
	curr = icon('icons/mob/widerobot.dmi', "medihound")
	curr.Insert(icon('icons/mob/widerobot.dmi', "medihound-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "medihound-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "medihound-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Medical (dog - medihound)"] = curr
	curr = icon('icons/mob/widerobot.dmi', "medihounddark")
	curr.Insert(icon('icons/mob/widerobot.dmi', "medihounddark-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "medihounddark-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "medihounddark-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Medical (dog - medihounddark)"] = curr
	curr = icon('icons/mob/widerobot.dmi', "valemed")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valemed-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valemed-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valemed-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Medical (dog - valemed)"] = curr
	//Sec
	curr = icon('icons/mob/widerobot.dmi', "k9")
	curr.Insert(icon('icons/mob/widerobot.dmi', "k9-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "k9-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "k9-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Security (dog - k9)"] = curr
	curr = icon('icons/mob/widerobot.dmi', "k9dark")
	curr.Insert(icon('icons/mob/widerobot.dmi', "k9dark-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "k9dark-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "k9dark-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Security (dog - k9dark)"] = curr
	curr = icon('icons/mob/widerobot.dmi', "valesec")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valesec-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valesec-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valesec-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Security (dog - valesec)"] = curr
	//Service
	curr = icon('icons/mob/widerobot.dmi', "valeserv")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valeserv-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valeserv-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valeserv-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Service (dog - valeserv)"] = curr
	curr = icon('icons/mob/widerobot.dmi', "valeservdark")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valeservdark-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valeservdark-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valeservdark-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Service (dog - valeservdark)"] = curr
	//Sci
	curr = icon('icons/mob/widerobot.dmi', "valesci")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valesci-rest"), "rest")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valesci-sit"), "sit")
	curr.Insert(icon('icons/mob/widerobot.dmi', "valesci-bellyup"), "bellyup")
	process_holoform_icon_filter(curr, HOLOFORM_FILTER_PAI, FALSE)
	.["Cyborg - Science (dog - valesci)"] = curr
	//Misc
	.["Cyborg - Misc (dog - blade)"] = process_holoform_icon_filter(icon('icons/mob/widerobot.dmi', "blade"), HOLOFORM_FILTER_PAI, FALSE)
