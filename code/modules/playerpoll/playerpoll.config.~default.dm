...
#error "PLAYER POLL MODULE NOT CONFIGURED"
#endif

/*
//The entire module requires a managed database system for the macros to work correctly. Meaning, there has to be a database datum of some sort that's stored in a variable, and queries support the things here.
