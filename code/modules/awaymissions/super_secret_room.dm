...
/obj/structure/speaking_tile/interact(mob/user)
	...
	switch(times_spoken_to)
		...
		if(251)
			...
			var/obj/item/food/reagent_containers/drinks/trophy/silver_cup/the_ride = new(get_turf(user))
		...
		if(5643)
			...
			var/obj/item/food/reagent_containers/drinks/trophy/gold_cup/never_ends = new(get_turf(user))
