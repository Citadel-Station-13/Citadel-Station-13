...
/datum/design/emptybottle
	...
	build_path = /obj/item/food/reagent_containers/drinks/bottle/blank/small
	category = list("Equipment")
	departmental_flags = DEPARTMENTAL_FLAG_SERVICE
...
/datum/design/largeemptybottle
	...
	build_path = /obj/item/food/reagent_containers/drinks/bottle/blank
	category = list("Equipment")
	departmental_flags = DEPARTMENTAL_FLAG_SERVICE
...
/datum/design/emptypitcher
	...
	build_path = /obj/item/food/reagent_containers/drinks/bottle/blank/pitcher
	category = list("Equipment")
	departmental_flags = DEPARTMENTAL_FLAG_SERVICE
