...
/datum/design/bottle/export/tequila
	...
	id = "tequila_export"
	reagents_list = list(/datum/reagent/consumable/ethanol/tequila = 40, /datum/reagent/consumable/lemonjuice = 20)
...
/datum/design/bottle/export/applejack
	...
	id = "applejack_export"
	reagents_list = list(/datum/reagent/consumable/ethanol/applejack = 25, /datum/reagent/consumable/ethanol/gin = 5)
...
/datum/design/bottle/export/blazaam
	...
	id = "blazaam_export"
	reagents_list = list(/datum/reagent/consumable/ethanol/blazaam = 40, /datum/reagent/water/holywater = 10)
