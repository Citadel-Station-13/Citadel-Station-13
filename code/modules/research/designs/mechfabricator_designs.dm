...
/datum/design/borg_upgrade_holding
	...
	materials = list(/datum/material/iron = 10000, /datum/material/gold = 250, /datum/material/uranium = 500)
	construction_time = 120
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_upgrade_defibrillator
	...
	materials = list(/datum/material/iron=15000, /datum/material/glass=15000, /datum/material/silver=10000, /datum/material/gold=10000, /datum/material/titanium=5000, /datum/material/diamond=5000)
	construction_time = 120
	category = list("Cyborg Upgrade Modules")
