...
/datum/nanite_program/adrenaline/on_trigger()
	host_mob.do_adrenaline(-10, TRUE, TRUE, FALSE, TRUE, /datum/reagent/medicine/stimulants = 1.5, "<span class='notice'>You feel a sudden surge of energy!</span>", FALSE, FALSE, FALSE)
