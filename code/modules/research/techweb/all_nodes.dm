...
/datum/techweb_node/adv_engi
	...
	design_ids = list("engine_goggles", "magboots", "forcefield_projector", "weldingmask", "tray_goggles_prescription", "engine_goggles_prescription", "mesons_prescription", "rtg")
...
/datum/techweb_node/anomaly
	...
	design_ids = list("reactive_armour", "anomaly_neutralizer", "rtg_advanced")
...
/datum/techweb_node/adv_power
	...
	design_ids = list("smes", "super_cell", "hyper_cell", "super_capacitor", "superpacman", "power_turbine", "power_turbine_console", "power_compressor", "circulator", "teg")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 3000)
	export_price = 5000
...
/datum/techweb_node/bluespace_power
	...
	design_ids = list("bluespace_cell", "quadratic_capacitor", "mrspacman")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
