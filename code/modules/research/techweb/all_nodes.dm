...
/datum/techweb_node/adv_weaponry
	...
	design_ids = list("pin_loyalty", "disablercarbine")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 7500)
...
/datum/techweb_node/heavy_beam_weapons
	id = "heavy_beam_weapons"
	display_name = "Heavy Beam Weaponry"
	description = "Various upgraded versions of basic beam weapons"
	prereq_ids = list("adv_weaponry")
	design_ids = list("disablercannon", "lasercannon")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
