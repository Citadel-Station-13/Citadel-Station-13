...
/datum/techweb_node/adv_biotech
	...
	prereq_ids = list("biotech")
	design_ids = list("piercesyringe", "crewpinpointer", "handheldcrewmonitor", "smoke_machine", "plasmarefiller", "limbgrower", "defibrillator", "meta_beaker", "healthanalyzer_advanced","harvester","holobarrier_med","smartdartgun","medicinalsmartdart", "pHmeter")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
