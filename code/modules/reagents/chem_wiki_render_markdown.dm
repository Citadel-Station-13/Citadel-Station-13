...
/client/proc/generate_wikichem_list_md()
	set name = "Generate Wikichems.md"
	set category = "Debug"
...
/proc/generate_chemwiki_line_md(datum/reagent/R, X, processCR)
...
/proc/generate_chemreactwiki_line_md(datum/chemical_reaction/CR)
