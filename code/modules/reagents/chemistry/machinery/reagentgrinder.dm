...
/obj/machinery/reagentgrinder
	...
	var/static/radial_examine = image(icon = 'modular_citadel/icons/mob/radial.dmi', icon_state = "radial_examine")
	var/static/radial_eject = image(icon = 'modular_citadel/icons/mob/radial.dmi', icon_state = "radial_eject")
	var/static/radial_grind = image(icon = 'modular_citadel/icons/mob/radial.dmi', icon_state = "radial_grind")
	var/static/radial_juice = image(icon = 'modular_citadel/icons/mob/radial.dmi', icon_state = "radial_juice")
	var/static/radial_mix = image(icon = 'modular_citadel/icons/mob/radial.dmi', icon_state = "radial_mix")
