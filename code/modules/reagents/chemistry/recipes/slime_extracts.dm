...
/datum/chemical_reaction/slime/slimecell/on_reaction(datum/equilibrium/reaction, datum/reagents/holder, created_volume)
...
/datum/chemical_reaction/slime/slimeRNG/on_reaction(datum/equilibrium/reaction, datum/reagents/holder, created_volume)
	if(multiplier >= 5)
