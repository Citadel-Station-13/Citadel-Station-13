...
/datum/chemical_reaction/medicine/baked_banana_peel
...
/datum/chemical_reaction/medicine/coagulant_weak
...
/datum/chemical_reaction/medicine/synthtissue/FermiCreate(datum/reagents/holder, added_volume, added_purity)
...
/datum/chemical_reaction/medicine/pen_jelly
	name = "Pentetic Jelly"
...
/datum/chemical_reaction/medicine/suture
	required_reagents = list(/datum/reagent/cellulose = 2, /datum/reagent/medicine/styptic_powder = 2)

/datum/chemical_reaction/medicine/suture/on_reaction(datum/equilibrium/reaction, datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
		new /obj/item/stack/medical/suture/(location)

/datum/chemical_reaction/medicine/mesh
	required_reagents = list(/datum/reagent/cellulose = 2, /datum/reagent/medicine/silver_sulfadiazine = 2)

/datum/chemical_reaction/medicine/mesh/on_reaction(datum/equilibrium/reaction, datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/chemical_reaction/medicine/limb_regrowth
