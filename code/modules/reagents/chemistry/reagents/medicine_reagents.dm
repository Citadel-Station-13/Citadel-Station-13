...
/datum/reagent/medicine/trophazole/on_mob_life(mob/living/carbon/M)
	M.adjustBruteLoss(-1.5*REAGENTS_EFFECT_MULTIPLIER, 0.) // heals 3 brute & 0.5 burn if taken with food. compared to 2.5 brute from bicard + nutriment
	..()
	. = 1
...
/datum/reagent/medicine/thializid/overdose_process(mob/living/carbon/M)
	...
	M.adjust_disgust(3)
	M.reagents.add_reagent(/datum/reagent/medicine/oxalizid, 0.225 * REAGENTS_EFFECT_MULTIPLIER)
	..()
	. = 1
