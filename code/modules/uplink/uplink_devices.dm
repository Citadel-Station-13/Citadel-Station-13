<<<<<<< HEAD:code/game/objects/items/devices/uplink_devices.dm
...
/obj/item/device/radio/uplink/old/Initialize(mapload, _owner, _tc_amount = 10)
	...
	GET_COMPONENT(hidden_uplink, /datum/component/uplink)
	hidden_uplink.name = "dusty radio"
>>>>>>> ea2c37c... Merge pull request #33276 from Cyberboss/FixUplinks:code/modules/uplink/uplink_devices.dm
