/obj/machinery/vending/liberationstation
	...
	products = list(/obj/item/reagent_containers/food/burger/plain = 5, //O say can you see, by the dawn's early light
					/obj/item/reagent_containers/food/burger/baseball = 3, //What so proudly we hailed at the twilight's last gleaming
					/obj/item/reagent_containers/food/fries = 5, //Whose broad stripes and bright stars through the perilous fight
	...
	premium = list(/obj/item/ammo_box/magazine/smgm9mm = 2,
					...
					/obj/item/reagent_containers/food/cheesyfries = 5,
					/obj/item/reagent_containers/food/burger/baconburger = 5) //Premium burgers for the premium section
	contraband = list(/obj/item/clothing/under/misc/patriotsuit = 3,
					/obj/item/bedsheet/patriot = 5,
					/obj/item/reagent_containers/food/burger/superbite = 3) //U S A
