...
/obj/item/reagent_containers/food/snacks/grown/holymelon/Initialize()
	...
	AddComponent(/datum/component/anti_magic, TRUE, TRUE, FALSE, SLOT_FLAG_HANDS, uses, TRUE, CALLBACK(src, .proc/block_magic), CALLBACK(src, .proc/expire)) //deliver us from evil o melon god
