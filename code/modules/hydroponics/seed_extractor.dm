...
/obj/machinery/seed_extractor/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		. += "<span class='notice'>The status display reads: Extracting <b>[seed_multiplier*100]%</b> seed(s) per piece of produce.<br>Machine can store up to <b>[max_seeds]</b> seeds.</span>"
