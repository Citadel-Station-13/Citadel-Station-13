...
/obj/item/seeds/proc/mutate(lifemut = 2, endmut = 5, productmut = 1, yieldmut = 2, potmut = 25, wrmut = 2, wcmut = 5, traitmut = 0)
	adjust_lifespan(rand(-lifemut,lifemut/1.25))
	adjust_endurance(rand(-endmut,endmut/1.25))
	adjust_production(rand(-productmut,productmut/1.25))
	adjust_yield(rand(-yieldmut,yieldmut/1.25))
	adjust_potency(rand(-potmut,potmut/1.25))
	adjust_weed_rate(rand(-wrmut, wrmut/1.25))
	adjust_weed_chance(rand(-wcmut, wcmut/1.25))
	if(prob(traitmut))
