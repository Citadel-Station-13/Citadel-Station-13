...
/datum/sprite_accessory/penis
	icon = 'icons/arousal/penis_onmob.dmi'
	icon_state = null
...
/datum/sprite_accessory/penis/taur_flared
	icon = 'icons/arousal/taur_penis_onmob.dmi' //Needed larger width
	icon_state = "flared"
	name = "Taur, Flared"
...
/datum/sprite_accessory/testicles
	icon = 'icons/arousal/testicles_onmob.dmi'
	icon_state = "testicle"
...
/datum/sprite_accessory/vagina
	icon = 'icons/arousal/vagina_onmob.dmi'
	icon_state = null
	name = "vagina"
	gender_specific = 0
	color_src = "vag_color"
...
/datum/sprite_accessory/breasts
	icon = 'icons/arousal/breasts_onmob.dmi'
	icon_state = null
	name = "breasts"
	gender_specific = 0
