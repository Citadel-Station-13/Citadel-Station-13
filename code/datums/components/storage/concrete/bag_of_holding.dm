/datum/component/storage/concrete/bluespace/bag_of_holding/handle_item_insertion(obj/item/W, prevent_warning = FALSE, mob/living/user)
	...
	if(istype(W, /obj/item/storage/backpack/holding) || matching.len)
		...
		user.Knockdown(60, TRUE, TRUE)
		to_chat(user, "<span class='danger'>The bluespace explosion seriously wounds you!</span>")
		for(var/turf/T in range(4,loccheck))
			...
			T.TerraformTurf(/turf/open/chasm/magic/updated, /turf/open/chasm/magic/updated)
