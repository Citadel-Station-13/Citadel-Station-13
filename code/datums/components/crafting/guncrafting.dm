...
/obj/item/weaponcrafting/receiver/stock/attackby(obj/item/P, mob/user, params)
	...
	if(istype(P, /obj/item/pipe))
		var/obj/item/weaponcrafting/receiver/stock/barrled/B = /obj/item/weaponcrafting/receiver/stock/barrled
		to_chat(user, "<span class='notice'>You add [P] to [src]!</span>")
		qdel(P)
		qdel(src)
		new B(user.loc, 1)

/obj/item/weaponcrafting/receiver/stock/barrled
	name = "gun assembly"
	desc = "A classic rifle stock that doubles as a grip, roughly carved out of wood, this one has a modular receiver attached."
...
/obj/item/weaponcrafting/receiver/stock/barrled/attackby(obj/item/W, mob/user, params)
	...
	if(istype(W, /obj/item/stack/packageWrap))
		...
		if(W.use(15))
			...
			to_chat(user, "<span class='warning'>You need at least ten lengths of package wrap if you want to make a attach this pipe!</span>")

/obj/item/weaponcrafting/receiver/stock/barrled/gun
	name = "gun assembly"
	desc = "A classic rifle stock that doubles as a grip, roughly carved out of wood, this one has a modular receiver firmly attached. Adding a new pipe would allow for a rifle to be made, well sawing it down will make a smaller hangun."
	icon_state = "mounted_receiver_piped_wrapped"

/obj/item/weaponcrafting/receiver/stock/barrled/gun/attackby(obj/item/D, mob/user, params)
...
/obj/item/weaponcrafting/receiver/stock/barrled/gun/long
...
/obj/item/weaponcrafting/receiver/stock/barrled/gun/long/attackby(obj/item/D, mob/user, params)
	if(istype(D, /obj/item/screwdriver))
		to_chat(user, "<span class='notice'>You start attaching the gun to the frame...</span>")
		if(D.use_tool(src, user, 40, volume=100))
...
/obj/item/weaponcrafting/receiver/stock/barrled/gun/short
...
/obj/item/weaponcrafting/receiver/stock/barrled/gun/short/attackby(obj/item/D, mob/user, params)
	if(istype(D, /obj/item/screwdriver))
		to_chat(user, "<span class='notice'>You start attaching the gun to the frame...</span>")
		if(D.use_tool(src, user, 40, volume=100))
