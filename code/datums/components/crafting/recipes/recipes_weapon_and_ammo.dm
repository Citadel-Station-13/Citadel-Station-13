...
/datum/crafting_recipe/molotov
	name = "Molotov"
	result = /obj/item/food/reagent_containers/drinks/bottle/molotov
	reqs = list(/obj/item/reagent_containers/rag = 1,
				/obj/item/food/reagent_containers/drinks/bottle = 1)
	parts = list(/obj/item/food/reagent_containers/drinks/bottle = 1)
	time = 40
	category = CAT_WEAPONRY
	subcategory = CAT_WEAPON
...
/datum/crafting_recipe/IED
	...
	reqs = list(/datum/reagent/fuel = 50,
				/obj/item/stack/cable_coil = 1,
				/obj/item/assembly/igniter = 1,
				/obj/item/food/reagent_containers/drinks/soda_cans = 1)
	parts = list(/obj/item/food/reagent_containers/drinks/soda_cans = 1)
	time = 15
	category = CAT_WEAPONRY
	subcategory = CAT_OTHER
