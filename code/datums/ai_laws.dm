...
/datum/ai_laws/default/asimov
	...
	id = "asimov"
	inherent = list("You may not injure a human, cause a human to come to harm, or, through inaction, allow a human to suffer critical condition inducing harm, loss of limb or life, or permanent functional incapacitation.",\
