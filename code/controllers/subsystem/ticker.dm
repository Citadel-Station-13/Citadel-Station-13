...
/datum/subsystem/ticker/New()
	...
	login_music = pickweight(list('sound/ambience/title4.ogg' = 31, 'sound/ambience/title5.ogg' = 31, 'sound/ambience/title6.ogg' =31, 'sound/ambience/clown.ogg' = 7)) // choose title music!
