...
// #define GENITALS_BEHIND_LAYER	32		//Some genitalia needs to be behind everything, such as with taurs (Taurs use body_behind_layer // ERP Removal
...
// #define GENITALS_FRONT_LAYER	27		//Draws some genitalia above clothes and the TAUR body if need be. // ERP Removal
...
// #define GENITALS_EXPOSED_LAYER	15 // ERP Removal
