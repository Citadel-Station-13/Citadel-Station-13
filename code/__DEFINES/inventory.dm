...
/proc/slotdefine2slotbit(slotdefine) //Keep this up to date with the value of SLOT BITMASKS and SLOTS (the two define sections above)
	...
	switch(slotdefine)
		...
		if(INVENTORY_SLOT_UNIFORM)
			. = ITEM_SLOT_ICLOTHING
		if(INVENTORY_SLOT_L_STORE, INVENTORY_SLOT_R_STORE)
			. = ITEM_SLOT_POCKET
...
GLOBAL_LIST_INIT(no_genitals_update_slots, list(INVENTORY_SLOT_L_STORE, INVENTORY_SLOT_R_STORE, INVENTORY_SLOT_S_STORE, INVENTORY_SLOT_PUT_IN_BACKPACK, INVENTORY_SLOT_LEGCUFFED, INVENTORY_SLOT_HANDCUFFED, INVENTORY_SLOT_PUT_IN_HANDS, INVENTORY_SLOT_GENERC_DEXTROUS_STORAGE))
