...
#define BODYTEMP_HEAT_DAMAGE_LIMIT			(20) // The limit the human body can take before it starts taking damage from heat, relative to body temp
#define BODYTEMP_COLD_DAMAGE_LIMIT			(-50) // The limit the human body can take before it starts taking damage from coldness.
