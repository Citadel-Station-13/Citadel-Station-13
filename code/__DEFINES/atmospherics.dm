...
#define BODY_CONDUCTION_COEFFICIENT			0.01		// The conduction coefficient for mob temperature sharing
...
#define BODYTEMP_AUTORECOVERY_MAXIMUM		0.2		//Maximum amount of kelvin moved toward 310K per tick.
...
#define BODYTEMP_HEAT_DAMAGE_LIMIT			(T0C + 57) // The limit the human body can take before it starts taking damage from heat, relative to body temp
#define BODYTEMP_COLD_DAMAGE_LIMIT			(T0C - 13) // The limit the human body can take before it starts taking damage from coldness.
