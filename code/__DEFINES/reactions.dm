...
#define FIRE_METHANE_ENERGY_RELEASED		891000 //Amount of heat released per mole of burnt methane
#define METHANE_AUTOIGNITION_POINT			810-FIRE_MINIMUM_TEMPERATURE_TO_EXIST
