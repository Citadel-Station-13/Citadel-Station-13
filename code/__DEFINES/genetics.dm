...
#define DNA_UNI_IDENTITY_BLOCKS		16
...
#define DNA_COCK_BLOCK				8
#define	DNA_COCK_SHAPE_BLOCK		9
#define DNA_COCK_COLOR_BLOCK		10
#define DNA_COCK_SIZE_BLOCK			11
#define DNA_BALLS_BLOCK				12
#define DNA_BALLS_INTERNAL			13
#define DNA_BALLS_COLOR_BLOCK		14
#define DNA_BALLS_FLUID_BLOCK		15
#define DNA_BALLS_SIZE_BLOCK		16
/*ADD TO LIST AS THEY BECOME AVAILABLE
#define DNA_VAGINA_BLOCK
#define DNA_VAGINA_COLOR_BLOCK
#define DNA_WOMB_BLOCK
#define DNA_BREASTS_BLOCK
#define DNA_BREASTS_SIZE_BLOCK
#define DNA_BREASTS_FLUID_BLOCK
#define DNA_MUTCOLOR1_BLOCK
#define DNA_MUTCOLOR2_BLOCK
#define DNA_MUTCOLOR3_BLOCK
#define DNA_SPECIES_BLOCK
#define DNA_MAM_TAIL_BLOCK
#define DNA_MAM_EARS_BLOCK
#define DNA_MAM_BODYMARKINGS_BLOCK
#define DNA_MAM_SNOUT_BLOCK
*/
