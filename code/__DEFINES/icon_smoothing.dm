...
DEFINE_BITFIELD(smooth_flags, list(
...
DEFINE_BITFIELD(smooth_junction, list(
...
#define QUEUE_SMOOTH(thing_to_queue) if(thing_to_queue.smooth_flags & (SMOOTH_CORNERS|SMOOTH_BITMASK)) {SSicon_smooth.add_to_queue(thing_to_queue)}
...
#define IS_SMOOTH(atom)	(atom.smooth_flags & (SMOOTH_CORNERS|SMOOTH_BITMASK))

/**SMOOTHING GROUPS
 * Groups of things to smooth with.
 * * Contained in the `list/smooth_groups` variable.
 * * Matched with the `list/smooth_with` variable to check whether smoothing is possible or not.
 */
...
#define SMOOTH_GROUP_FLOOR_COBBLESTONE	S_TURF(14)
...
#define SMOOTH_GROUP_CHASM				S_TURF(21)
#define SMOOTH_GROUP_WALL_CULT			S_TURF(22)
...
#define SMOOTH_GROUP_FLOOR_ICE			S_TURF(34)
#define SMOOTH_GROUP_FLOOR_HOLOCARPET	S_TURF(35)
#define SMOOTH_GROUP_WALL_ICE			S_TURF(36)
#define SMOOTH_GROUP_WALL_MINERAL		S_TURF(37)
#define SMOOTH_GROUP_FLOOR_SNOW			S_TURF(38)
#define SMOOTH_GROUP_FLOOR_ROCKY		S_TURF(39)
#define SMOOTH_GROUP_FLOOR_ASH			S_TURF(40)
#define SMOOTH_GROUP_SIDEWALK			S_TURF(41)
#define SMOOTH_GROUP_TRAIN_PLATFORM		S_TURF(42)
#define SMOOTH_GROUP_WALL_BLUEGLACIER	S_TURF(43)
...
#define SMOOTH_GROUP_TABLE_FANCY		S_OBJ(3)
...
#define SMOOTH_GROUP_TABLE_CLOCKWORK	S_OBJ(19)
#define SMOOTH_GROUP_TABLE_WOOD			S_OBJ(20)
#define SMOOTH_GROUP_TABLE_BRASS		S_OBJ(21)
