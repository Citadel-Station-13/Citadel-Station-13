...
#define SMOOTH_GROUP_CARPET_GREEN
#define SMOOTH_GROUP_CARPET_ORANGE
#define SMOOTH_GROUP_CARPET_PURPLE
#define SMOOTH_GROUP_CARPET_CYAN
#define SMOOTH_GROUP_CARPET_ROYALBLACK
#define SMOOTH_GROUP_CARPET_ROYALBLUBE
#define SMOOTH_GROUP_CARPET_BLACK
