...
#define TURF_CONSTRUCT_FLAGS_PLATING_OVER			(TURF_CONSTRUCT_ROD_LATTICE | TURF_CONSTRUCT_ROD_CATWALK | TURF_CONSTRUCT_TILE_PLATING | TURF_CONSTRUCT_RCD_PLATING | TURF_CONSTRUCT_ALLOW_FROM_UNDER)
#warn implement rcd
