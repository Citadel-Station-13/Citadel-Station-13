...
#define TURF_CONSTRUCT_FLAGS_SANDBOX				(TURF_CONSTRUCT_ROD_LATTICE | TURF_CONSTRUCT_ROD_CATWALK | TURF_CONSTRUCT_TILE_PLATING | TURF_CONSTRUCT_ALLOW_FROM_UNDER | TURF_CONSTRUCT_RCD_PATING | DECONSTRUCT_RCD_TEARDOWN | TURF_DECONSTRUCT_ALLOW_FROM_UNDER)
