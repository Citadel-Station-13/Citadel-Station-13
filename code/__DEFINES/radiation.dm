...
#define RAD_MINIMUM_CONTAMINATION 10				// How strong does a radiation wave have to be to contaminate objects
#define RAD_CONTAMINATION_CHANCE_COEFFICIENT 0.005	// Higher means higher strength scaling contamination chance
#define RAD_CONTAMINATION_STR_COEFFICIENT 0.95		// Higher means higher strength scaling contamination strength
