...
GLOBAL_LIST_INIT(bitfields, list(
	...
	"zm_flags" = list(
		"ZM_MIMIC_BELOW" = ZM_MIMIC_BELOW,
		"ZM_MIMIC_OVERWRITE" = ZM_MIMIC_OVERWRITE,
		"ZM_NO_OCCLUDE" = ZM_NO_OCCLUDE
	)	,
	"zmm_flags" = list(
	...
	"turf_construct_flags" = list(
		FLAG(TURF_CONSTRUCT_ROD_LATTICE)
		FLAG(TURF_CONSTRUCT_ROD_CATWALK)
		FLAG(TURF_CONSTRUCT_TILE_PLATING)
		FLAG(TURF_CONSTRUCT_TILE_PLATING_DIRECT)
		FLAG(TURF_CONSTRUCT_RCD_PLATING)
		FLAG(TURF_CONSTRUCT_ALLOW_FROM_UNDER)
		FLAG(TURF_DECONSTRUCT_ALLOW_FROM_UNDER)
		FLAG(TURF_DECONSTRUCT_RCD_TEARDOWN)
	)
	))
#undef FLAG
