GLOBAL_LIST_INIT(bitfields, list(
	...
	"pipe_flags" = list(
		...
		"PIPING_AUTO_SHIFT_OFFSETS" = PIPING_AUTO_SHIFT_OFFSETS,
		"PIPING_AUTO_DOUBLE_SHIFT_OFFSETS" = PIPING_AUTO_DOUBLE_SHIFT_OFFSETS
	),
	"pipenet_flags" = list(
		"PIPENET_DIRECT_ATTACH" = PIPENET_DIRECT_ATTACH,
		"PIPENET_POTENTIAL_VALVE" = PIPENET_POTENTIAL_VALVE
	)
	))
