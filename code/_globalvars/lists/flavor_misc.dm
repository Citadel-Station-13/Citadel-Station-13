...
GLOBAL_LIST_INIT(species_heirlooms, list(
	"dwarf" = list(25, list(/obj/item/food/reagent_containers/drinks/dwarf_mug)), //example: 25% chance for dwarves to get a dwarf mug as their heirloom (normal container but has manly dorf icon)
